#line 1 "..\\..\\App\\App_FaultHandler.c"
#line 1 "..\\..\\App\\App_FaultHandler.h"
...
#line 23 "..\\..\\App\\App_FaultHandler.h"
...
#line 2 "..\\..\\App\\App_FaultHandler.c"
#line 1 "..\\..\\App\\App_Motor_Project.h"
...
#line 5 "..\\..\\App\\App_Motor_Project.h"
#line 6 "..\\..\\App\\App_Motor_Project.h"
...
#line 7 "..\\..\\App\\App_Motor_Project.h"
...
#line 8 "..\\..\\App\\App_Motor_Project.h"
#line 9 "..\\..\\App\\App_Motor_Project.h"
#line 1 "..\\..\\Dev\\dev_io.h"
...
#line 10 "..\\..\\App\\App_Motor_Project.h"
#line 11 "..\\..\\App\\App_Motor_Project.h"


#line 14 "..\\..\\App\\App_Motor_Project.h"
#line 15 "..\\..\\App\\App_Motor_Project.h"
#line 16 "..\\..\\App\\App_Motor_Project.h"


#line 19 "..\\..\\App\\App_Motor_Project.h"
...
#line 60 "..\\..\\App\\App_Motor_Project.h"
...
#line 107 "..\\..\\App\\App_Motor_Project.h"
...
#line 3 "..\\..\\App\\App_FaultHandler.c"
#line 4 "..\\..\\App\\App_FaultHandler.c"
#line 1 "..\\..\\Utils\\Params.h"



#line 5 "..\\..\\Utils\\Params.h"
#line 6 "..\\..\\Utils\\Params.h"
#line 7 "..\\..\\Utils\\Params.h"
#line 1 "..\\..\\Utils\\param_manager.h"



#line 5 "..\\..\\Utils\\param_manager.h"
...
#line 6 "..\\..\\Utils\\param_manager.h"
#line 7 "..\\..\\Utils\\param_manager.h"
#line 8 "..\\..\\Utils\\param_manager.h"
#line 9 "..\\..\\Utils\\param_manager.h"

#line 11 "..\\..\\Utils\\param_manager.h"
...
extern Param_Debug_t    g_ParamDebug;    
...
#line 8 "..\\..\\Utils\\Params.h"



 
#line 22 "..\\..\\Utils\\Params.h"
...
#line 91 "..\\..\\Utils\\Params.h"

 
#line 100 "..\\..\\Utils\\Params.h"
...
typedef struct {
    ...
    uint16_t voltage_upper_limit;    
    uint16_t voltage_lower_limit;    
    uint16_t current_upper_limit;    
    uint16_t current_detect_ms;      
    int16_t  close_limit_angle;      
    int16_t  open_limit_angle;       
    uint32_t baud_rate;              

     
    uint16_t voltage_upper_hysteresis;    
    uint16_t voltage_lower_hysteresis;    
    uint8_t  overvoltage_trigger_count;   
    uint8_t  undervoltage_trigger_count;  
    uint16_t current_hysteresis_ma;       
    uint16_t current_release_ms;          
    uint8_t  overcurrent_trigger_count;   
    uint8_t  reserved[3];                 
...
extern AppParamRecord_t g_AppParam;          
...
_Bool Param_IsValidRegister(uint16_t regAddr);

#line 5 "..\\..\\App\\App_FaultHandler.c"
#line 6 "..\\..\\App\\App_FaultHandler.c"
#line 7 "..\\..\\App\\App_FaultHandler.c"
#line 8 "..\\..\\App\\App_FaultHandler.c"
#line 9 "..\\..\\App\\App_FaultHandler.c"
#line 10 "..\\..\\App\\App_FaultHandler.c"
#line 11 "..\\..\\App\\App_FaultHandler.c"
...
static void FaultHandler_SetFault(uint16_t faultBit)
{
    ...
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Set fault bit 0x%04X, status=0x%04X" "\033[0m" "\r\n", "MAIN",faultBit, s_u16FaultStatus);
}

static void FaultHandler_ClearFaultBit(uint16_t faultBit)
{
    s_u16FaultStatus &= (uint16_t)(~faultBit);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Clear fault bit 0x%04X, status=0x%04X" "\033[0m" "\r\n", "MAIN",faultBit, s_u16FaultStatus);
}
...
static void FaultHandler_OnVoltageAlarm(void* payload)
{
    ...
    case 0:
        ...
        {
            FaultHandler_SetFault((0x0001U));
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Overvoltage triggered, set fault bit0, mV=%lu, threshold=%lu" "\033[0m" "\r\n", "MAIN",(unsigned long)pEvent->u32BusVoltageMv, (unsigned long)pEvent->u32ThresholdMv);
        ...
        else
        {
            ...
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Overvoltage released, fault bit persists until manual clear, mV=%lu, threshold=%lu" "\033[0m" "\r\n", "MAIN",(unsigned long)pEvent->u32BusVoltageMv, (unsigned long)pEvent->u32ThresholdMv);
    ...
    case 1:
        if (pEvent->u8IsActive)
        {
            FaultHandler_SetFault((0x0040U));
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Undervoltage triggered, set fault bit6, mV=%lu, threshold=%lu" "\033[0m" "\r\n", "MAIN",(unsigned long)pEvent->u32BusVoltageMv, (unsigned long)pEvent->u32ThresholdMv);
        ...
        else
        {
            ...
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Undervoltage released, fault bit persists until manual clear, mV=%lu, threshold=%lu" "\033[0m" "\r\n", "MAIN",(unsigned long)pEvent->u32BusVoltageMv, (unsigned long)pEvent->u32ThresholdMv);
    ...
    default:
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Unknown alarm type: %d" "\033[0m" "\r\n", "MAIN",(int)pEvent->u8AlarmType);
        break;
    }
}
...
static void FaultHandler_OnCurrentAlarm(void* payload)
{
    ...
    if (pEvent->u8IsActive)
    {
        ...
        DeviceNode_t* pstcMotorNode = DeviceManager_Get(0);
        if (pstcMotorNode != 0 && pstcMotorNode->private_data != 0)
        {
        ...
        if (eDesiredDir == DIR_FWD)
        {
            ...
            FaultHandler_SetFault((0x0002U));
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Overcurrent triggered (FWD), set fault bit, mA=%ld, threshold=%ld" "\033[0m" "\r\n", "MAIN",(long)pEvent->s32CurrentMa, (long)pEvent->s32ThresholdMa);
        ...
        else
        {
            ...
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Overcurrent triggered (dir=%d, REV/STOP is normal stall), skip fault bit, mA=%ld, threshold=%ld" "\033[0m" "\r\n", "MAIN",(int)eDesiredDir, (long)pEvent->s32CurrentMa, (long)pEvent->s32ThresholdMa);
    ...
    else
    {
        ...
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "Overcurrent released, fault bit persists until manual clear, mA=%ld, threshold=%ld" "\033[0m" "\r\n", "MAIN",(long)pEvent->s32CurrentMa, (long)pEvent->s32ThresholdMa);
...
void FaultHandler_Init(void)
{
    ...
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "FaultHandler initialized, subscribed to TOPIC_VOLTAGE_ALARM and TOPIC_CURRENT_ALARM" "\033[0m" "\r\n", "MAIN");
}
...
void FaultHandler_ClearFault(uint8_t u8FaultType)
{
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: type=%d\r\n" "\033[0m" "\r\n", "MAIN",(int)u8FaultType);
    
    
    DeviceNode_t* pstcVoltageNode = DeviceManager_Get(13);
    if (pstcVoltageNode == 0 || pstcVoltageNode->private_data == 0) {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Voltage device not found!\r\n" "\033[0m" "\r\n", "MAIN");
        return;
    }
    ...
    DeviceNode_t* pstcMotorNode = DeviceManager_Get(0);
    if (pstcMotorNode == 0 || pstcMotorNode->private_data == 0) {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Motor device not found!\r\n" "\033[0m" "\r\n", "MAIN");
        return;
    }
    MotorDevice_t* pstcMotorDev = (MotorDevice_t*)pstcMotorNode->private_data;
    ...
    case 0:
        ...
        Voltage_Device_ClearAlarm(pstcVoltageDev, 0);
        
        Motor_ClearVoltageBlock(pstcMotorDev, 0);
        
        FaultHandler_ClearFaultBit((0x0001U));
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Overvoltage cleared\r\n" "\033[0m" "\r\n", "MAIN");
        break;
        
    case 1:
        
        Voltage_Device_ClearAlarm(pstcVoltageDev, 1);
        
        Motor_ClearVoltageBlock(pstcMotorDev, 1);
        
        FaultHandler_ClearFaultBit((0x0040U));
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Undervoltage cleared\r\n" "\033[0m" "\r\n", "MAIN");
        break;
        
    case 2:
        {
            
            DeviceNode_t* pstcSensorNode = DeviceManager_Get(14);
            if (pstcSensorNode == 0 || pstcSensorNode->private_data == 0) {
                SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Current sensor device not found!\r\n" "\033[0m" "\r\n", "MAIN");
                return;
            }
            ...
            FaultHandler_ClearFaultBit((0x0002U));
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Overcurrent cleared\r\n" "\033[0m" "\r\n", "MAIN");
        }
        break;
        
    default:
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFault: Unknown fault type=%d\r\n" "\033[0m" "\r\n", "MAIN",(int)u8FaultType);
        break;
    }
}
...
void FaultHandler_ClearFaultByMask(uint16_t faultMask)
{
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[FAULT] " "ClearFaultByMask: mask=0x%04X\r\n" "\033[0m" "\r\n", "MAIN",(unsigned int)faultMask);
    
    if (faultMask & (0x0001U))
    {
        FaultHandler_ClearFault(0);
    }
    if (faultMask & (0x0040U))
    {
        FaultHandler_ClearFault(1);
    }
    if (faultMask & (0x0002U))
    {
        FaultHandler_ClearFault(2);
    }
