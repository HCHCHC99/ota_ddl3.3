...
#line 2 "..\\..\\Adp\\Comm_HAL.c"
#line 3 "..\\..\\Adp\\Comm_HAL.c"
#line 1 "..\\..\\Utils\\ring_buf.h"
...
#line 34 "..\\..\\Utils\\ring_buf.h"
#line 35 "..\\..\\Utils\\ring_buf.h"
#line 36 "..\\..\\Utils\\ring_buf.h"
...
_Bool BUF_Full(const stc_ring_buf_t *pstcBuf);
_Bool BUF_Empty(const stc_ring_buf_t *pstcBuf);
...
#line 5 "..\\..\\Adp\\Comm_HAL.c"
#line 6 "..\\..\\Adp\\Comm_HAL.c"
...
static volatile _Bool m_bTxIdle;
...
static void HAL_FrameParser(void)
{
    ...
    {
        uint8_t frameBuf[(256U)];
        uint16_t frameLen = available;
        if (frameLen > (256U)) frameLen = (256U);
        ...
        MsgQueue_Send(&m_stcRxFrameQueue, &rxMsg, 0, "HAL_FrameParser");
    }
}
...
_Bool Comm_HAL_Send(const uint8_t *data, uint16_t len)
{
    if (data == 0 || len == 0 || len > (256U)) return 0;
    ...
    else
    {
        ...
        return MsgQueue_Send(&m_stcTxQueue, &txMsg, 0, "HAL_Send");
    }
}
