...
#line 2 "..\\..\\Dev\\dev_adc.c"
#line 3 "..\\..\\Dev\\dev_adc.c"
#line 4 "..\\..\\Dev\\dev_adc.c"
#line 5 "..\\..\\Dev\\dev_adc.c"
#line 6 "..\\..\\Dev\\dev_adc.c"
...
static void ADC_UpdateCache(ADC_Device_t* pstcDev)
{
    ...
    if (pstcDev->stcConfig.enAcqMode == ADC_ACQ_MODE_INTERRUPT)
    {
        ...
        pstcDev->u16AverageValue = pstcDev->u16RawValue; 
...
static void ADC_AdpLayerInit(ADC_Device_t* pstcDev)
{
     ...
     
    {
        ...
        ADC_ChCmd((((CM_ADC_TypeDef *)(0x40040000UL))), (0U), pstcDev->stcConfig.u8Channel, ENABLE);

        ((void)0);
#line 139 "..\\..\\Dev\\dev_adc.c"
    }
...
DeviceResult_t ADC_Device_Init(void* handle)
{
    ...
    if (pstcDev == 0) return RESULT_PARAM_ERR;

    
    char cPort = '?';
    switch (pstcDev->stcConfig.u8Port)
    {
        case (0x00U): cPort = 'A'; break;
        case (0x01U): cPort = 'B'; break;
        case (0x02U): cPort = 'C'; break;
        case (0x03U): cPort = 'D'; break;
        case (0x04U): cPort = 'E'; break;
        case (0x05U): cPort = 'H'; break;
        default: break;
    }
    ...
    {
        case (0x0001U): u8PinNum = 0;  break;
        case (0x0002U): u8PinNum = 1;  break;
        case (0x0004U): u8PinNum = 2;  break;
        case (0x0008U): u8PinNum = 3;  break;
        case (0x0010U): u8PinNum = 4;  break;
        case (0x0020U): u8PinNum = 5;  break;
        case (0x0040U): u8PinNum = 6;  break;
        case (0x0080U): u8PinNum = 7;  break;
        case (0x0100U): u8PinNum = 8;  break;
        case (0x0200U): u8PinNum = 9;  break;
        case (0x0400U): u8PinNum = 10; break;
        case (0x0800U): u8PinNum = 11; break;
        case (0x1000U): u8PinNum = 12; break;
        case (0x2000U): u8PinNum = 13; break;
        case (0x4000U): u8PinNum = 14; break;
        case (0x8000U): u8PinNum = 15; break;
        default: break;
    }
...
{
    ADC_Device_t* pstcDev = (ADC_Device_t*)handle;
    if (pstcDev == 0 || data == 0) return RESULT_PARAM_ERR;
...
{
    ADC_Device_t* pstcDev = (ADC_Device_t*)handle;
    if (pstcDev == 0 || pstcCmd == 0) return RESULT_PARAM_ERR;
    if (!pstcDev->u8Initialized) return RESULT_ERROR;

    switch (pstcCmd->cmd)
    {
        case (0x3000 + 0x01):
            if (pstcCmd->response != 0 && pstcCmd->response_size >= sizeof(uint16_t))
            {
...
{
    ADC_Device_t* pstcDev = (ADC_Device_t*)handle;
    if (pstcDev == 0) return RESULT_ERROR;
    if (!pstcDev->u8Initialized) return RESULT_ERROR;
...
uint16_t ADC_Device_GetRawValue(ADC_Device_t* pstcDev)
{
    if (pstcDev == 0 || !pstcDev->u8Initialized) return 0;
