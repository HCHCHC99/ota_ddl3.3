...
#line 2 "..\\..\\Dev\\dev_rturn.c"
#line 3 "..\\..\\Dev\\dev_rturn.c"
#line 4 "..\\..\\Dev\\dev_rturn.c"
#line 5 "..\\..\\Dev\\dev_rturn.c"
#line 6 "..\\..\\Dev\\dev_rturn.c"
...
static void RTurn_UpdateAngle(RTurn_Device_t* pstcDev) {
    ...
    
    {
        ...
        if (u8CheckDir == 0 && pstcDev->u8LastDesiredDir != 0) {
            u8CheckDir = pstcDev->u8LastDesiredDir;
        }
        
        if (!pstcDev->stcLockState.u8LockActive && u8CheckDir != 0 && !pstcDev->u8LimitTriggered) {
            uint8_t u8Alarm = RTurn_ReadSensorAlarm(pstcDev);
            
            if (u8Alarm) {
                
                uint8_t u8LimitDir = (u8CheckDir == 1) ? 1 : 2;
    ...
    if (pstcDev->stcLockState.u8LockActive) {
        if ((pstcDev->stcLockState.u8LockedDir == 1 && u8DesiredRTurnDir == 2) ||
            (pstcDev->stcLockState.u8LockedDir == 2 && u8DesiredRTurnDir == 1)) {
            
            uint8_t u8ReleaseDir = (pstcDev->stcLockState.u8LockedDir == 1) ? 1 : 2;
            ...
            if (u8DesiredRTurnDir != 0) {
                ...
                if (u8Alarm) {
                    ...
                    uint8_t u8NewLimitDir = (u8DesiredRTurnDir == 1) ? 1 : 2;
                    
                    if (u8DesiredRTurnDir == 2) {
    ...
    if (pstcDev->u8Calibrated) {
        ...
        if (pstcDev->stcLockState.u8LockActive && 
            ...
            if (pstcDev->stcLockState.u8LockedDir == 2) {
                 
                if (u32Now - s_u32LastLockDebugPrintTime >= 4000) {
        ...
        if (pstcDev->u8CurrentDir == 1) {
            pstcDev->fCurrentAngle += fDeltaAngle;
        } else if (pstcDev->u8CurrentDir == 2) {
            pstcDev->fCurrentAngle -= fDeltaAngle;
        }
        ...
        if (pstcDev->fCurrentAngle >= pstcDev->stcConfig.fMaxAngle) {
            ...
            if (!pstcDev->u8LimitTriggered) {
                ...
                pstcDev->stcLockState.u8LockedDir = 1;
                pstcDev->stcLockState.u8LockActive = 1;
                
                RTurn_LimitEvent_t stcEvent;
                stcEvent.u8Direction = 1;  
                stcEvent.fAngle = pstcDev->fCurrentAngle;
                stcEvent.u8IsActive = 1;
                EventBus_Publish(TOPIC_RTURN_LIMIT, &stcEvent);
...
static void RTurn_HandleOvercurrent(RTurn_Device_t* pstcDev) {
    ...
    if (u8CurrentDir != 0) {
        ...
        uint8_t u8LimitDir = (u8CurrentDir == 1) ? 1 : 2;
...
DeviceResult_t RTurn_Device_Update(void* handle) {
    ...
    if (u32Now - s_u32LastLockPrintTime >= 2000) {
        s_u32LastLockPrintTime = u32Now;
        
        if (pstcDev->stcLockState.u8LockActive) {
            const char* pcLockDir = (pstcDev->stcLockState.u8LockedDir == 1) ? "FORWARD" :
                                    (pstcDev->stcLockState.u8LockedDir == 2) ? "REVERSE" : "NONE";
    ...
    if (pstcDev->u8Calibrated && (u32Now - s_u32LastLimitPrintTime >= 4000)) {
