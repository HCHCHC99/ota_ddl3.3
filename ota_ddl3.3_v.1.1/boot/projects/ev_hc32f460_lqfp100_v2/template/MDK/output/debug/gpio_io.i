...
#line 2 "..\\..\\Adp\\Gpio_io.c"
#line 3 "..\\..\\Adp\\Gpio_io.c"
#line 4 "..\\..\\Adp\\Gpio_io.c"
...
void Output_GPIO_Init(uint8_t u8Port, uint16_t u16Pin, en_gpio_init_state_t enInitState)
{
    ...
    stcGpioInit.u16PinDir         = ((0x0002U));       
    stcGpioInit.u16PinState       = (0U);      
    stcGpioInit.u16PinOutputType  = (0U); 
    stcGpioInit.u16PinDrv         = ((0x0020U));      
    stcGpioInit.u16PullUp         = (0U);        
    stcGpioInit.u16Invert         = (0U);      
    stcGpioInit.u16Latch          = (0U);     
    stcGpioInit.u16ExtInt         = (0U);    
    stcGpioInit.u16PinAttr        = (0U);  
    
     
    GPIO_Init(u8Port, u16Pin, &stcGpioInit);
    
     
    GPIO_SetFunc(u8Port, u16Pin, (0U));
...
void Input_GPIO_Init(uint8_t u8Port, uint16_t u16Pin, en_functional_state_t enablePullUp)
{
    ...
    stcGpioInit.u16PinDir         = (0U);        
    stcGpioInit.u16PullUp         = (enablePullUp == ENABLE) ? ((0x0040U)) : (0U);
    stcGpioInit.u16PinAttr        = (0U);  
    stcGpioInit.u16ExtInt         = (0U);    
