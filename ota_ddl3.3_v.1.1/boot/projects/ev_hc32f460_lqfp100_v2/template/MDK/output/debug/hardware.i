...
#line 2 "..\\..\\Adp\\Hardware.c"
#line 3 "..\\..\\Adp\\Hardware.c"
#line 4 "..\\..\\Adp\\Hardware.c"
#line 1 "..\\..\\Adp\\Dma.h"
...
#line 5 "..\\..\\Adp\\Hardware.c"
#line 6 "..\\..\\Adp\\Hardware.c"
...
static void Pa6_Adc_Init(void)
{
    ...
    stcAdcConfig.u8Channel = (6U);           
    stcAdcConfig.stcPin.u8Port = (0x00U);          
    stcAdcConfig.stcPin.u8Pin = (0x0040U);            
    

     
    stcAdcConfig.enMode = ADC_MODE_DMA;
    stcAdcConfig.pfnCallback = 0;                     
    stcAdcConfig.stcDmaConfig.u16BufferSize = 8;
    stcAdcConfig.stcDmaConfig.u8DmaChannel = 1;
    
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PA6_ADC] Initializing PA6 (CH6) in DMA mode, DMA1 CH%d, buffer=%d\r\n" "\033[0m" "\r\n", "MAIN",1, 8);
#line 109 "..\\..\\Adp\\Hardware.c"
    
     
    s_u8Pa6AdcId = Adc_Create(&stcAdcConfig);
    if (s_u8Pa6AdcId == 0xFF) {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PA6_ADC] ERROR: Failed to create ADC instance!\r\n" "\033[0m" "\r\n", "MAIN");
        return;
    }
    ...
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PA6_ADC] PA6 ADC initialized successfully! ADC_ID=%d\r\n" "\033[0m" "\r\n", "MAIN",s_u8Pa6AdcId);
}
...
void Pa6_Adc_Process(void)
{
    ...
    if ((u32Now - s_u32LastPrintMs) >= 500) {
        ...
        if (s_u8Pa6AdcId != 0xFF) {
            ...
            SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "PA6 DMA: Raw=%4u, %3umV, Avg=%4u, %3umV, Cnt=%lu\r\n" "\033[0m" "\r\n", "MAIN",u16Raw, u16Voltage, u16Avg, u16AvgMv, u32Samples);
#line 161 "..\\..\\Adp\\Hardware.c"
...
void Hardware_Init(void)
{
    ...
    Output_GPIO_Init((0x05U), (0x0004U), GPIO_INIT_HIGH);
	Output_GPIO_Init((0x01U), (0x0040U), GPIO_INIT_HIGH);
    CanIf_Init();
