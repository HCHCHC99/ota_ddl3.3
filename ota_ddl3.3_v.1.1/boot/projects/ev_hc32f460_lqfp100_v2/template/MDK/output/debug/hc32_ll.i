#line 1 "../../../../drivers/hc32_ll_driver/src/hc32_ll.c"
...
#line 25 "../../../../drivers/hc32_ll_driver/src/hc32_ll.c"
#line 26 "../../../../drivers/hc32_ll_driver/src/hc32_ll.c"
...
void LL_PERIPH_WE(uint32_t u32Peripheral)
{
    ...
    if ((u32Peripheral & (1UL << 0U)) != 0UL) {
         
        EFM_REG_Unlock();
    }


    if ((u32Peripheral & (1UL << 1U)) != 0UL) {
         
        PWC_FCG0_REG_Unlock();
    }


    if ((u32Peripheral & (1UL << 2U)) != 0UL) {
         
        GPIO_REG_Unlock();
    }
#line 91 "../../../../drivers/hc32_ll_driver/src/hc32_ll.c"
    if ((u32Peripheral & (1UL << 4U)) != 0UL) {
         
        PWC_REG_Unlock((0xA508U));
    }


    if ((u32Peripheral & (1UL << 6U)) != 0UL) {
         
        PWC_REG_Unlock((0xA501U) | (0xA502U));
    }


    if ((u32Peripheral & (1UL << 7U)) != 0UL) {
...
#line 137 "../../../../drivers/hc32_ll_driver/src/hc32_ll.c"
    if ((u32Peripheral & (1UL << 4U)) != 0UL) {
         
        PWC_REG_Lock((0xA508U));
    }


    if ((u32Peripheral & (1UL << 6U)) != 0UL) {
         
        PWC_REG_Lock((0xA501U) | (0xA502U));
    }
