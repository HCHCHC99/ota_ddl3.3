#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c"
...
#line 28 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c"
...
#line 29 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c"
...
void AOS_CommonTriggerCmd(uint32_t u32Target, uint32_t u32CommonTrigger, en_functional_state_t enNewState)
{
    do { ((( ((u32Target) >= (uint32_t)(&((CM_AOS_TypeDef *)(0x40010800UL))->DCU_TRGSEL1)) && ((u32Target) <= (uint32_t)(&((CM_AOS_TypeDef *)(0x40010800UL))->COMTRG2)) && (((u32Target) & 0x03UL) == 0UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c", 124)); } while (0);
    do { ((( ((u32CommonTrigger) != 0UL) && ((u32CommonTrigger) | ((1UL << 30U) | (1UL << 31U))) == ((1UL << 30U) | (1UL << 31U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c", 125)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c", 126)); } while (0);

    if (ENABLE == enNewState) {
        ((*(volatile uint32_t *)u32Target) |= ((uint32_t)(u32CommonTrigger)));
    } else {
        ((*(volatile uint32_t *)u32Target) &= ((uint32_t)(~((uint32_t)(u32CommonTrigger)))));
    }
}
...
void AOS_SetTriggerEventSrc(uint32_t u32Target, en_event_src_t enSource)
{
    do { ((( ((u32Target) >= (uint32_t)(&((CM_AOS_TypeDef *)(0x40010800UL))->DCU_TRGSEL1)) && ((u32Target) <= (uint32_t)(&((CM_AOS_TypeDef *)(0x40010800UL))->COMTRG2)) && (((u32Target) & 0x03UL) == 0UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_aos.c", 143)); } while (0);

    ((((*(volatile uint32_t *)u32Target)) = ((uint32_t)((((((*(volatile uint32_t *)u32Target))) & ((uint32_t)(~((uint32_t)((0x1FFUL)))))) | ((uint32_t)(enSource) & (uint32_t)((0x1FFUL))))))));
}
