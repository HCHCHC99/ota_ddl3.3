#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c"
...
#line 34 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c"
...
#line 35 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c"
...
static uint32_t CRC_ConvertCrcValue(uint32_t u32CrcValue)
{
    ...
    const uint32_t u32ConvertFlag = (((0x00000004UL)) | ((0x00000008UL)) | ((0x00000010UL)));

    u32Config = (((CM_CRC_TypeDef *)(0x40008C00UL))->CR);

    if ((u32Config & u32ConvertFlag) != u32ConvertFlag) {
        if ((u32Config & (0x00000002UL)) == ((0x00000002UL))) {
            u8Size = 32U;
        } else {
            u8Size = 16U;
        }

        if ((u32Config & (0x00000008UL)) == (0x0UL)) {
            u32FinalCrcValue = __rbit(u32FinalCrcValue);  
            if (u8Size == 16U) {
        ...
        if ((u32Config & (0x00000010UL)) == (0x0UL)) {
            u32FinalCrcValue = ~u32FinalCrcValue;    
        }

        if ((u32Config & (0x00000004UL)) == (0x0UL)) {
            u8Size /= 8U;
             
            for (i = 0U; i < u8Size; i++) {
                u8Offset = i * 8U;
                u32Temp  = (u32FinalCrcValue >> u8Offset) & 0xFFUL;
                u32Temp  = __rbit(u32Temp);  
...
{
    uint32_t i;
    volatile uint8_t *reg8DR = (volatile uint8_t *)((uint32_t)(&((CM_CRC_TypeDef *)(0x40008C00UL))->DAT0));
...
{
    uint32_t i;
    volatile uint16_t *reg16DR = (volatile uint16_t *)((uint32_t)(&((CM_CRC_TypeDef *)(0x40008C00UL))->DAT0));
    for (i = 0UL; i < u32Len; i++) {
        *reg16DR = au16Data[i];
    }
}
...
{
    uint32_t i;
    volatile uint32_t *reg32DR = (volatile uint32_t *)((uint32_t)(&((CM_CRC_TypeDef *)(0x40008C00UL))->DAT0));
    for (i = 0UL; i < u32Len; i++) {
        *reg32DR = au32Data[i];
    }
}
...
int32_t CRC_StructInit(stc_crc_init_t *pstcCrcInit)
{
    ...
    if (0 != pstcCrcInit) {
        pstcCrcInit->u32Protocol = (0x0UL);
        pstcCrcInit->u32InitValue = (0xFFFFFFFFUL);
        pstcCrcInit->u32RefIn = ((0x00000004UL));
        pstcCrcInit->u32RefOut = ((0x00000008UL));
        pstcCrcInit->u32XorOut = ((0x00000010UL));
        i32Ret = (0);
    }
...
int32_t CRC_Init(const stc_crc_init_t *pstcCrcInit)
{
    ...
    if (0 != pstcCrcInit) {
        do { ((( ((pstcCrcInit->u32Protocol) == (0x0UL)) || ((pstcCrcInit->u32Protocol) == ((0x00000002UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 287)); } while (0);
        do { ((( ((pstcCrcInit->u32RefIn) == ((0x00000004UL))) || ((pstcCrcInit->u32RefIn) == (0x0UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 288)); } while (0);
        do { ((( ((pstcCrcInit->u32RefOut) == ((0x00000008UL))) || ((pstcCrcInit->u32RefOut) == (0x0UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 289)); } while (0);
        do { ((( ((pstcCrcInit->u32XorOut) == ((0x00000010UL))) || ((pstcCrcInit->u32XorOut) == (0x0UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 290)); } while (0);

        ((((CM_CRC_TypeDef *)(0x40008C00UL))->CR) = ((uint32_t)((pstcCrcInit->u32RefIn | pstcCrcInit->u32RefOut | pstcCrcInit->u32XorOut))));

        ((((((CM_CRC_TypeDef *)(0x40008C00UL))->CR)) = ((uint32_t)((((((((CM_CRC_TypeDef *)(0x40008C00UL))->CR))) & ((uint32_t)(~((uint32_t)(((0x00000002UL))))))) | ((uint32_t)(pstcCrcInit->u32Protocol) & (uint32_t)(((0x00000002UL)))))))));

         
        if ((0x0UL) == (pstcCrcInit->u32Protocol & ((0x00000002UL)))) {
            ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint16_t)((uint16_t)pstcCrcInit->u32InitValue)));
        } else {
            ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint32_t)(pstcCrcInit->u32InitValue)));
        }
        i32Ret = (0);
    }
    return i32Ret;
...
{
    int32_t i32Ret = (0);
    ((((CM_CRC_TypeDef *)(0x40008C00UL))->CR) = ((uint32_t)((0x001CUL))));
...
uint32_t CRC_GetResult(void)
{
    if (((0x00000002UL)) == ((((CM_CRC_TypeDef *)(0x40008C00UL))->CR) & ((uint32_t)((0x00000002UL))))) {
        return (((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT);
    } else {
        return ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) & ((uint32_t)(0x0000FFFFUL)));
    }
}
...
{
    if (((0x00000002UL)) == ((((CM_CRC_TypeDef *)(0x40008C00UL))->CR) & ((uint32_t)((0x00000002UL))))) {
        ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint32_t)(u32Value)));
    } else {
        ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint32_t)(u32Value & 0x0000FFFFUL)));
    }
}
...
en_flag_status_t CRC_GetResultStatus(void)
{
    ...
    if (((((CM_CRC_TypeDef *)(0x40008C00UL))->CR) & ((uint32_t)((0x00000002UL)))) == ((0x00000002UL))) {
        u32Status = ((((CM_CRC_TypeDef *)(0x40008C00UL))->FLG) & ((uint32_t)((0x00000001UL))));
    } else {
        u32Status = ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) & ((uint32_t)((0x00010000UL))));
    }
...
int32_t CRC_CRC16_AccumulateData(uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint16_t *pu16Out)
{
    ...
    if ((pvData != 0) && (u32Len != 0UL)) {
        do { ((( ((u8DataWidth) == (1U)) || ((u8DataWidth) == (2U)) || ((u8DataWidth) == (4U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 390)); } while (0);

         
        if ((4U) == u8DataWidth) {
            CRC_WriteData32((const uint32_t *)pvData, u32Len);
        } else if ((2U) == u8DataWidth) {
        ...
        if (pu16Out != 0) {
            ...
            *pu16Out = (uint16_t)(((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT);
            i32Ret = (0);
        }
    }
...
int32_t CRC_CRC32_AccumulateData(uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint32_t *pu32Out)
{
    ...
    if ((pvData != 0) && (u32Len != 0UL)) {
        do { ((( ((u8DataWidth) == (1U)) || ((u8DataWidth) == (2U)) || ((u8DataWidth) == (4U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_crc.c", 432)); } while (0);
        ...
        if (pu32Out != 0) {
            ...
            *pu32Out = (((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT);
            i32Ret = (0);
        }
    }
...
int32_t CRC_CRC16_Calculate(uint16_t u16InitValue, uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint16_t *pu16Out)
{
    ...
    if ((pvData != 0) && (u32Len != 0UL)) {
        ...
        ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint16_t)(u16InitValue)));
...
int32_t CRC_CRC32_Calculate(uint32_t u32InitValue, uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint32_t *pu32Out)
{
    ...
    if ((pvData != 0) && (u32Len != 0UL)) {
        ...
        ((((CM_CRC_TypeDef *)(0x40008C00UL))->RESLT) = ((uint32_t)(u32InitValue)));
...
en_flag_status_t CRC_CRC16_CheckData(uint16_t u16InitValue, uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint16_t u16ExpectValue)
{
    volatile uint32_t u32Count = (10UL);
    en_flag_status_t enStatus = RESET;
    uint32_t u32ExpectValueTemp = u16ExpectValue;

    if ((pvData != 0) && (u32Len != 0UL)) {
        (void)CRC_CRC16_Calculate(u16InitValue, u8DataWidth, pvData, u32Len, 0);
...
en_flag_status_t CRC_CRC32_CheckData(uint32_t u32InitValue, uint8_t u8DataWidth, const void *pvData, uint32_t u32Len, uint32_t u32ExpectValue)
{
    ...
    if ((pvData != 0) && (u32Len != 0UL)) {
        (void)CRC_CRC32_Calculate(u32InitValue, u8DataWidth, pvData, u32Len, 0);
