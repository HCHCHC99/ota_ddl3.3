#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c"
...
#line 42 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c"
...
#line 43 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c"
...
#line 120 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c"
...
static int32_t EFM_WaitEnd(uint8_t u8Shift, uint32_t u32Time)
{
    ...
    if ((-8) == EFM_WaitFlag(((0x00000100UL)) << u8Shift, u32Time)) {
        i32Ret = (-5);
    }
    if ((0) == i32Ret) {
        if (SET == EFM_GetStatus(((0x00000010UL)) << u8Shift)) {
             
            EFM_ClearStatus(((0x00000010UL)) << u8Shift);
        } else {
            i32Ret = (-1);
        }
    }
...
static int32_t EFM_WaitReadBackEnd(uint8_t u8Shift)
{
    ...
    if ((-8) == EFM_WaitFlag(((0x00000100UL)) << u8Shift, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL))) {
        i32Ret = (-5);
    }
    if ((0) == i32Ret) {
         
        if (SET == EFM_GetStatus(((0x00000008UL)) << u8Shift)) {
             
            EFM_ClearStatus(((0x00000008UL)) << u8Shift);
            i32Ret = (-1);
        }
        if ((0) == i32Ret) {
            if (SET == EFM_GetStatus(((0x00000010UL)) << u8Shift)) {
...
void EFM_Cmd(uint32_t u32Flash, en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 310)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 311)); } while (0);
    do { ((((u32Flash) == ((0x00000001UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 312)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_EFM_TypeDef *)(0x40010400UL))->FSTP) &= ((uint32_t)(~((uint32_t)(u32Flash)))));
    } else {
        ((((CM_EFM_TypeDef *)(0x40010400UL))->FSTP) |= ((uint32_t)(u32Flash)));
    }
}
...
int32_t EFM_SetWaitCycle(uint32_t u32WaitCycle)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 335)); } while (0);
    do { ((((u32WaitCycle) <= (15U << (4U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 336)); } while (0);

    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC))) & ((uint32_t)(~((uint32_t)((0x000000F0UL)))))) | ((uint32_t)(u32WaitCycle) & (uint32_t)((0x000000F0UL))))))));
    while (u32WaitCycle != ((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC) & ((uint32_t)((0x000000F0UL))))) {
        u32Timeout++;
        if (u32Timeout > ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL)) {
            return (-8);
        }
    }
    return (0);
...
void EFM_CacheRamReset(en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 355)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 356)); } while (0);

    ((((bCM_EFM_TypeDef *)0x42208000UL)->FRMC_b . CRST) = ((uint32_t)(enNewState)));
}
...
void EFM_CacheCmd(en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 369)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 370)); } while (0);

    ((((bCM_EFM_TypeDef *)0x42208000UL)->FRMC_b . CACHE) = ((uint32_t)(enNewState)));
}
...
void EFM_LowVoltageReadCmd(en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 383)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 384)); } while (0);

    ((((bCM_EFM_TypeDef *)0x42208000UL)->FRMC_b . SLPMD) = ((uint32_t)(enNewState)));
}
...
int32_t EFM_SwapCmd(en_functional_state_t enNewState)
{
    ...
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 402)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 403)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 404)); } while (0);

     
    u32Tmp = ((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC) & ((uint32_t)(((0x01000000UL) | (0x00010000UL)))));
     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC) &= ((uint32_t)(~((uint32_t)(((0x01000000UL) | (0x00010000UL)))))));

    if (enNewState == ENABLE) {
         
        ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x1UL << (4U))) & (uint32_t)((0x00000070UL))))))));
         
        (*(volatile uint32_t *)((0x0007FFDCUL))) = (0xFFFF4321UL);
         
        i32Ret = EFM_WaitEnd(0U, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL));
    } else {
         
        ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x4UL << (4U))) & (uint32_t)((0x00000070UL))))))));
         
        (*(volatile uint32_t *)((0x0007FFDCUL))) = 0x0UL;
         
         
        i32Ret = EFM_WaitEnd(0U, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 50UL));
    }

     
    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x0UL << (4U))) & (uint32_t)((0x00000070UL))))))));

     
    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC))) & ((uint32_t)(~((uint32_t)(((0x01000000UL) | (0x00010000UL))))))) | ((uint32_t)(u32Tmp) & (uint32_t)(((0x01000000UL) | (0x00010000UL)))))))));
...
en_flag_status_t EFM_GetSwapStatus(void)
{
    return ((0UL == (((bCM_EFM_TypeDef *)0x42208000UL)->FSWP_b . FSWP)) ? SET : RESET);
}
...
void EFM_LowVoltageCmd(en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 455)); } while (0);
    ((((bCM_EFM_TypeDef *)0x42208000UL)->FRMC_b . LVM) = ((uint32_t)(enNewState)));
}
...
{
    int32_t i32Ret = (0);
    do { ((( ((u32Mode) == (0x1UL << (4U))) || ((u32Mode) == (0x2UL << (4U))) || ((u32Mode) == (0x3UL << (4U))) || ((u32Mode) == (0x4UL << (4U))) || ((u32Mode) == (0x5UL << (4U))) || ((u32Mode) == (0x0UL << (4U))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 470)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 471)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 472)); } while (0);
    if ((-8) == EFM_WaitFlag(((0x00000100UL)), ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 62500UL))) {
        i32Ret = (-5);
    }

    if (i32Ret == (0)) {
         
        ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)(u32Mode) & (uint32_t)((0x00000070UL))))))));
    }
    return i32Ret;
}
...
void EFM_IntCmd(uint32_t u32EfmInt, en_functional_state_t enNewState)
{
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 496)); } while (0);
    do { (((((u32EfmInt) | ((0x00000001UL) | (0x00000002UL) | (0x00000004UL))) == ((0x00000001UL) | (0x00000002UL) | (0x00000004UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 497)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 498)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_EFM_TypeDef *)(0x40010400UL))->FITE) |= ((uint32_t)(u32EfmInt)));
    } else {
        ((((CM_EFM_TypeDef *)(0x40010400UL))->FITE) &= ((uint32_t)(~((uint32_t)(u32EfmInt)))));
    }
}
...
en_flag_status_t EFM_GetAnyStatus(uint32_t u32Flag)
{
    do { (((((u32Flag) | (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL)))) == (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 515)); } while (0);

    return ((0UL == ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(u32Flag)))) ? RESET : SET);
}
...
en_flag_status_t EFM_GetStatus(uint32_t u32Flag)
{
    do { (((((u32Flag) | (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL)))) == (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 528)); } while (0);

    return ((u32Flag == ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(u32Flag)))) ? SET : RESET);
}
...
void EFM_ClearStatus(uint32_t u32Flag)
{
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 542)); } while (0);
    do { (((((u32Flag) | (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL)))) == (((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 543)); } while (0);

    ((((CM_EFM_TypeDef *)(0x40010400UL))->FSCLR) = ((uint32_t)(u32Flag)));
}
...
void EFM_SetBusStatus(uint32_t u32Status)
{
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 558)); } while (0);
    do { ((( ((u32Status) == (0x0UL)) || ((u32Status) == (0x1UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 559)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 560)); } while (0);

    ((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . BUSHLDCTL) = ((uint32_t)(u32Status)));
}
...
{
    int32_t i32Ret = (-3);
    volatile uint8_t *pu8Buf = (uint8_t *)u32Addr;
    uint32_t u32Len = u32ByteLen;
    uint32_t u32ReadyFlag = ((0x00000100UL));

    do { ((( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x03000C00UL)) && ((u32Addr) <= (0x03000FFBUL))) || (((u32Addr) >= (0x0317FFE0UL)) && ((u32Addr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 582)); } while (0);
    do { ((( ((u32Addr + u32ByteLen - 1UL) <= (0x0007FFFFUL)) || (((u32Addr + u32ByteLen - 1UL) >= (0x03000C00UL)) && ((u32Addr + u32ByteLen - 1UL) <= (0x03000FFBUL))) || (((u32Addr + u32ByteLen - 1UL) >= (0x0317FFE0UL)) && ((u32Addr + u32ByteLen - 1UL) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 583)); } while (0);

    if (0 != pu8ReadBuf) {
        if ((0) == EFM_WaitFlag(u32ReadyFlag, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL))) {
            while (0UL != u32Len) {
                *(pu8ReadBuf++) = *(pu8Buf++);
                u32Len--;
            }
...
int32_t EFM_Program(uint32_t u32Addr, const uint8_t *pu8Buf, uint32_t u32Len)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 622)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 623)); } while (0);
    do { ((( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x03000C00UL)) && ((u32Addr) <= (0x03000FFBUL))) || (((u32Addr) >= (0x0317FFE0UL)) && ((u32Addr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 624)); } while (0);
    do { ((( ((u32Addr + u32Len - 1UL) <= (0x0007FFFFUL)) || (((u32Addr + u32Len - 1UL) >= (0x03000C00UL)) && ((u32Addr + u32Len - 1UL) <= (0x03000FFBUL))) || (((u32Addr + u32Len - 1UL) >= (0x0317FFE0UL)) && ((u32Addr + u32Len - 1UL) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 625)); } while (0);
    do { (((0UL == (((uint32_t)(u32Addr)) & 0x3UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 626)); } while (0);

    u8Shift = 0U;

     
    EFM_ClearStatus((((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL))));
    ...
    while ((u32LoopWords-- > 0UL) && ((0) == i32Ret)) {
         
        *u32pDest++ = *u32pSource++;
         
        i32Ret = EFM_WaitEnd(u8Shift, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL));
    }

    if ((0U != u32RemainBytes) && ((0) == i32Ret)) {
...
int32_t EFM_ProgramWord(uint32_t u32Addr, uint32_t u32Data)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 677)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 678)); } while (0);
    do { ((( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x03000C00UL)) && ((u32Addr) <= (0x03000FFBUL))) || (((u32Addr) >= (0x0317FFE0UL)) && ((u32Addr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 679)); } while (0);
    do { (((0UL == (((uint32_t)(u32Addr)) & 0x3UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 680)); } while (0);
...
int32_t EFM_ProgramWordReadBack(uint32_t u32Addr, uint32_t u32Data)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 722)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 723)); } while (0);
    do { ((( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x03000C00UL)) && ((u32Addr) <= (0x03000FFBUL))) || (((u32Addr) >= (0x0317FFE0UL)) && ((u32Addr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 724)); } while (0);
    do { (((0UL == (((uint32_t)(u32Addr)) & 0x3UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 725)); } while (0);
    ...
    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x2UL << (4U))) & (uint32_t)((0x00000070UL))))))));
     
    (*(volatile uint32_t *)(u32Addr)) = (uint32_t)u32Data;
...
__attribute__((noinline)) __attribute__((section("RAMCODE"))) int32_t EFM_SequenceProgram(uint32_t u32Addr, const uint8_t *pu8Buf, uint32_t u32Len)
{
    int32_t i32Ret = (0);
    uint32_t u32Tmp;
    uint32_t u32LoopWords = u32Len >> 2UL;
    ...
    if (!(((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) {
        return (-5);
    }
    if ((!(((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) || (!( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x03000C00UL)) && ((u32Addr) <= (0x03000FFBUL))) || (((u32Addr) >= (0x0317FFE0UL)) && ((u32Addr) <= (0x0317FFFFUL))))) || (!( ((u32Addr + u32Len - 1UL) <= (0x0007FFFFUL)) || (((u32Addr + u32Len - 1UL) >= (0x03000C00UL)) && ((u32Addr + u32Len - 1UL) <= (0x03000FFBUL))) || (((u32Addr + u32Len - 1UL) >= (0x0317FFE0UL)) && ((u32Addr + u32Len - 1UL) <= (0x0317FFFFUL)))))) {
        return (-3);
    }
    if (!(0UL == (((uint32_t)(u32Addr)) & 0x3UL))) {
        return (-3);
    }

     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FSCLR) |= ((uint32_t)((((0x00000001UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000002UL)) | ((0x00000020UL)) | ((0x00000004UL)) | ((0x00000100UL))))));
     
    u32Tmp = ((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC) & ((uint32_t)(((0x01000000UL) | (0x00010000UL)))));
     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FRMC) &= ((uint32_t)(~((uint32_t)(((0x01000000UL) | (0x00010000UL)))))));
     
    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x3UL << (4U))) & (uint32_t)((0x00000070UL))))))));
    ...
    while (u32LoopWords-- > 0UL) {
        ...
        *u32pDest++ = *u32pSource++;
        ...
        u32Timeout = 0UL;
        while (((0x00000010UL)) != ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(((0x00000010UL)))))) {
            if (u32Timeout++ >= ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL)) {
                i32Ret = (-8);
                break;
            }
        ...
        u32Timeout = 0UL;
        while (((0x00000010UL)) == ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(((0x00000010UL)))))) {
            ((((CM_EFM_TypeDef *)(0x40010400UL))->FSCLR) |= ((uint32_t)(((0x00000010UL)))));
            if (u32Timeout++ >= ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL)) {
                i32Ret = (-8);
                break;
            }
    ...
    u32Timeout = 0UL;
    while (((0x00000100UL)) != ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(((0x00000100UL)))))) {
        if (u32Timeout++ >= ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 20000UL)) {
            i32Ret = (-8);
            break;
        }
...
int32_t EFM_SectorErase(uint32_t u32Addr)
{
    ...
    do { ((((u32Addr) <= (0x0007FFFFUL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 867)); } while (0);
    do { (((0UL == (((uint32_t)(u32Addr)) & 0x3UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 868)); } while (0);
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 869)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 870)); } while (0);
    ...
    (*(volatile uint32_t *)(u32Addr)) = 0UL;

     
    i32Ret = EFM_WaitEnd(u8Shift, ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 50UL));
...
__attribute__((noinline)) __attribute__((section("RAMCODE"))) int32_t EFM_ChipErase(uint8_t u8Chip)
{
    int32_t i32Ret = (0);
    uint32_t u32Tmp;
    ...
    if ((!(((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) || !((u8Chip) == ((0x00000001UL)))) {
        return (-3);
    }
    ...
    if (1UL == ((((bCM_EFM_TypeDef *)0x42208000UL)->FSWP_b . FSWP))) {
    ...
    ((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC)) = ((uint32_t)((((((((CM_EFM_TypeDef *)(0x40010400UL))->FWMC))) & ((uint32_t)(~((uint32_t)((0x00000070UL)))))) | ((uint32_t)((0x5UL << (4U))) & (uint32_t)((0x00000070UL))))))));
     
    (*(volatile uint32_t *)(u32Addr)) = 0UL;
     
    u32Timeout = 0UL;
    while ((((0x00000100UL)) << u8Shift) != ((((CM_EFM_TypeDef *)(0x40010400UL))->FSR) & ((uint32_t)(((0x00000100UL)) << u8Shift)))) {
        if (u32Timeout++ >= ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / 50UL)) {
            i32Ret = (-8);
            break;
        }
    }
     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FSCLR) |= ((uint32_t)(((0x00000010UL)) << u8Shift)));
...
void EFM_FWMC_Cmd(en_functional_state_t enNewState)
{
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 976)); } while (0);

    ((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE) = ((uint32_t)(enNewState)));
}
...
int32_t EFM_OTP_Lock(uint32_t u32Addr)
{
    ...
    if ((u32Addr >= (0x03000FC0UL)) && (u32Addr < (0x03000FFCUL))) {
        do { (((0UL == (((uint32_t)(u32Addr)) & 0x3UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 996)); } while (0);
        do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 997)); } while (0);
        do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 998)); } while (0);
        ...
        (*(volatile uint32_t *)(u32Addr)) = (uint32_t)0UL;
...
void EFM_SetWindowProtectAddr(uint32_t u32StartAddr, uint32_t u32EndAddr)
{
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1027)); } while (0);
    do { ((( ((u32StartAddr) <= (0x0007FFFFUL)) || (((u32StartAddr) >= (0x03000C00UL)) && ((u32StartAddr) <= (0x03000FFBUL))) || (((u32StartAddr) >= (0x0317FFE0UL)) && ((u32StartAddr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1028)); } while (0);
    do { ((( ((u32EndAddr) <= (0x0007FFFFUL)) || (((u32EndAddr) >= (0x03000C00UL)) && ((u32EndAddr) <= (0x03000FFBUL))) || (((u32EndAddr) >= (0x0317FFE0UL)) && ((u32EndAddr) <= (0x0317FFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1029)); } while (0);
     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FPMTSW) = ((uint32_t)(u32StartAddr)));
     
    ((((CM_EFM_TypeDef *)(0x40010400UL))->FPMTEW) = ((uint32_t)(u32EndAddr)));
}
...
{
    if (0 != pstcUID) {
        pstcUID->u32UniqueID0 = (((CM_EFM_TypeDef *)(0x40010400UL))->UQID0);
        pstcUID->u32UniqueID1 = (((CM_EFM_TypeDef *)(0x40010400UL))->UQID1);
        pstcUID->u32UniqueID2 = (((CM_EFM_TypeDef *)(0x40010400UL))->UQID2);
    }
}
...
{
    int32_t i32Ret = (0);
    if (0 == pstcEfmRemapInit) {
        i32Ret = (-3);
    } else {
        pstcEfmRemapInit->u32State = (0UL);
        pstcEfmRemapInit->u32Addr = 0UL;
        pstcEfmRemapInit->u32Size = (12UL);
    }
    return i32Ret;
}
...
{
    int32_t i32Ret = (0);
    volatile uint32_t *REMCRx;

    if (0 == pstcEfmRemapInit) {
        i32Ret = (-3);
    } else {
        do { (((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1086)); } while (0);
        do { ((( ((u8RemapIdx) == (0U)) || ((u8RemapIdx) == (1U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1087)); } while (0);
        do { ((( ((pstcEfmRemapInit->u32Size) >= (12UL)) && ((pstcEfmRemapInit->u32Size) <= (19UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1088)); } while (0);
        do { ((( ((pstcEfmRemapInit->u32Addr) <= (0x0007FFFFUL)) || (((pstcEfmRemapInit->u32Addr) >= (0x1FFF8000UL)) && ((pstcEfmRemapInit->u32Addr) <= (0x1FFFFFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1089)); } while (0);
        do { ((( ((pstcEfmRemapInit->u32State) == (0UL)) || ((pstcEfmRemapInit->u32State) == ((0x80000000UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1090)); } while (0);
        if ((pstcEfmRemapInit->u32Addr % (1UL << pstcEfmRemapInit->u32Size)) != 0U) {
            i32Ret = (-3);
        } else {
            REMCRx = &(*(volatile uint32_t *)((uint32_t)(&((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR0) + (4UL * (u8RemapIdx))));
            ((((*REMCRx)) = ((uint32_t)((((((*REMCRx))) & ((uint32_t)(~((uint32_t)((0x80000000UL) | (0x1FFFF000UL) | (0x0000001FUL)))))) | ((uint32_t)(pstcEfmRemapInit->u32State | pstcEfmRemapInit->u32Addr | pstcEfmRemapInit->u32Size) & (uint32_t)((0x80000000UL) | (0x1FFFF000UL) | (0x0000001FUL))))))));
...
void EFM_REMAP_DeInit(void)
{
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1109)); } while (0);

    ((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR0) = ((uint32_t)(0UL)));
    ((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR1) = ((uint32_t)(0UL)));
}
...
void EFM_REMAP_Cmd(uint8_t u8RemapIdx, en_functional_state_t enNewState)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1125)); } while (0);
    do { ((( ((u8RemapIdx) == (0U)) || ((u8RemapIdx) == (1U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1126)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1127)); } while (0);

    REMCRx = &(*(volatile uint32_t *)((uint32_t)(&((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR0) + (4UL * (u8RemapIdx))));
    if (ENABLE == enNewState) {
        ((*REMCRx) |= ((uint32_t)((0x80000000UL))));
    } else {
        ((*REMCRx) &= ((uint32_t)(~((uint32_t)((0x80000000UL))))));
    }
}
...
void EFM_REMAP_SetAddr(uint8_t u8RemapIdx, uint32_t u32Addr)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1147)); } while (0);
    do { ((( ((u8RemapIdx) == (0U)) || ((u8RemapIdx) == (1U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1148)); } while (0);
    do { ((( ((u32Addr) <= (0x0007FFFFUL)) || (((u32Addr) >= (0x1FFF8000UL)) && ((u32Addr) <= (0x1FFFFFFFUL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1149)); } while (0);

    REMCRx = &(*(volatile uint32_t *)((uint32_t)(&((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR0) + (4UL * (u8RemapIdx))));
    ((((*REMCRx)) = ((uint32_t)((((((*REMCRx))) & ((uint32_t)(~((uint32_t)((0x1FFFF000UL)))))) | ((uint32_t)(u32Addr) & (uint32_t)((0x1FFFF000UL))))))));
}
...
void EFM_REMAP_SetSize(uint8_t u8RemapIdx, uint32_t u32Size)
{
    ...
    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1165)); } while (0);
    do { ((( ((u8RemapIdx) == (0U)) || ((u8RemapIdx) == (1U)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1166)); } while (0);
    do { ((( ((u32Size) >= (12UL)) && ((u32Size) <= (19UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1167)); } while (0);

    REMCRx = &(*(volatile uint32_t *)((uint32_t)(&((CM_EFM_TypeDef *)(0x40010400UL))->MMF_REMCR0) + (4UL * (u8RemapIdx))));
    ((((*REMCRx)) = ((uint32_t)((((((*REMCRx))) & ((uint32_t)(~((uint32_t)((0x0000001FUL)))))) | ((uint32_t)(u32Size) & (uint32_t)((0x0000001FUL))))))));
}
...
void EFM_Protect_Enable(uint8_t u8Level)
{
    ...
    (void)EFM_Program((0x0317FFE0UL), u8Code, sizeof(u8Code));
    if ((1UL << 0UL) == u8Level) {
        (void)EFM_ProgramWord((0x00000410UL), (0xAF180402UL));
    } else if ((1UL << 1UL) == u8Level) {
        (void)EFM_ProgramWord((0x00000414UL), (0xA85173AEUL));
    } else {
...
int32_t EFM_WriteSecurityCode(const uint8_t *pu8Buf, uint32_t u32Len)
{
    ...
    uint32_t u32LoopWords = u32Len >> 2UL;
    uint32_t *u32pSource = (uint32_t *)(uint32_t)pu8Buf;
    uint32_t *u32pDest = (uint32_t *)(0x0317FFECUL);

    do { (((((CM_EFM_TypeDef *)(0x40010400UL))->FAPRT == 0x00000001UL)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1206)); } while (0);
    do { (((((bCM_EFM_TypeDef *)0x42208000UL)->FWMC_b . PEMODE == 1U)) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1207)); } while (0);
    do { ((((u32Len) <= (12UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_efm.c", 1208)); } while (0);
    ...
    (*(volatile uint32_t *)((0x0317FFECUL))) = 0UL;
