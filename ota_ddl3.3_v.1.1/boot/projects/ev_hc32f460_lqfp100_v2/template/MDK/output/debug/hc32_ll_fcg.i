#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c"
...
#line 26 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c"
...
#line 27 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c"
...
void FCG_Fcg0PeriphClockCmd(uint32_t u32Fcg0Periph, en_functional_state_t enNewState)
{
    do { ((( ((u32Fcg0Periph) != 0x00UL) && (((u32Fcg0Periph) | (0x8FF3C511UL)) == (0x8FF3C511UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 113)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 114)); } while (0);
    do { ((((((CM_PWC_TypeDef *)(0x40048000UL))->FCG0PC & (0x00000001UL)) == (0x00000001UL))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 115)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG0) &= ((uint32_t)(~((uint32_t)(u32Fcg0Periph)))));
    } else {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG0) |= ((uint32_t)(u32Fcg0Periph)));
    }
}
...
void FCG_Fcg1PeriphClockCmd(uint32_t u32Fcg1Periph, en_functional_state_t enNewState)
{
    do { ((( ((u32Fcg1Periph) != 0x00UL) && (((u32Fcg1Periph) | (0x0F0FFD79UL)) == (0x0F0FFD79UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 132)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 133)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG1) &= ((uint32_t)(~((uint32_t)(u32Fcg1Periph)))));
    } else {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG1) |= ((uint32_t)(u32Fcg1Periph)));
    }
}
...
void FCG_Fcg2PeriphClockCmd(uint32_t u32Fcg2Periph, en_functional_state_t enNewState)
{
    do { ((( ((u32Fcg2Periph) != 0x00UL) && (((u32Fcg2Periph) | (0x000787FFUL)) == (0x000787FFUL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 150)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 151)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG2) &= ((uint32_t)(~((uint32_t)(u32Fcg2Periph)))));
    } else {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG2) |= ((uint32_t)(u32Fcg2Periph)));
    }
}
...
void FCG_Fcg3PeriphClockCmd(uint32_t u32Fcg3Periph, en_functional_state_t enNewState)
{
    do { ((( ((u32Fcg3Periph) != 0x00UL) && (((u32Fcg3Periph) | (0x00001103UL)) == (0x00001103UL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 168)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_fcg.c", 169)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG3) &= ((uint32_t)(~((uint32_t)(u32Fcg3Periph)))));
    } else {
        ((((CM_PWC_TypeDef *)(0x40048000UL))->FCG3) |= ((uint32_t)(u32Fcg3Periph)));
    }
}
