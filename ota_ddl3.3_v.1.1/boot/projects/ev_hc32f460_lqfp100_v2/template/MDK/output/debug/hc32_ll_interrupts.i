#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c"
...
#line 33 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c"
...
#line 34 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c"
...
#line 79 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c"
...
static func_ptr_t m_apfnIrqHandler[(128U)] = {0};
...
int32_t INTC_IrqSignIn(const stc_irq_signin_config_t *pstcIrqSignConfig)
{
    ...
    if (0 == pstcIrqSignConfig) {
        i32Ret = (-3);
    } else {
        do { ((pstcIrqSignConfig->enIntSrc <= INT_SRC_MAX) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 205)); } while (0);
         
        if ((((((uint32_t)pstcIrqSignConfig->enIntSrc / (32UL)) * (6UL) + (32UL)) >                           (uint32_t)pstcIrqSignConfig->enIRQn)                                                    ||                     ((((uint32_t)pstcIrqSignConfig->enIntSrc / (32UL)) * (6UL) + (37UL)) <                          (uint32_t)pstcIrqSignConfig->enIRQn))                                                   &&                    ((uint32_t)pstcIrqSignConfig->enIRQn >= (32UL))) {
            ...
            INTC_SELx = (volatile uint32_t *)((uint32_t)(&((CM_INTC_TypeDef *)(0x40051000UL))->SEL0) + (4U * (uint32_t)(pstcIrqSignConfig->enIRQn)));
             
            if ((0x1FFUL) == ((*INTC_SELx) & (0x1FFUL))) {
                ((*INTC_SELx) = ((uint32_t)(pstcIrqSignConfig->enIntSrc)));
...
int32_t INTC_IrqSignOut(IRQn_Type enIRQn)
{
    ...
    if ((enIRQn < (INT000_IRQn)) || (enIRQn > (INT127_IRQn))) {
        ...
        INTC_SELx = (volatile uint32_t *)((uint32_t)(&((CM_INTC_TypeDef *)(0x40051000UL))->SEL0) + (4UL * (uint32_t)enIRQn));
        ((*INTC_SELx) = ((uint32_t)((0x1FFUL))));
        m_apfnIrqHandler[(uint8_t)enIRQn - (0U)] = 0;
    }
    return i32Ret;
}
...
void INTC_WakeupSrcCmd(uint32_t u32WakeupSrc, en_functional_state_t enNewState)
{
    ...
    do { ((( ((u32WakeupSrc) != 0x00UL) && (((u32WakeupSrc) | ((0x0000FFFFUL) | (0x00010000UL) | (0x00020000UL) | (0x00040000UL) | (0x00080000UL) | (0x00100000UL) | (0x00200000UL) | (0x00400000UL) | (0x00800000UL) | (0x02000000UL))) == ((0x0000FFFFUL) | (0x00010000UL) | (0x00020000UL) | (0x00040000UL) | (0x00080000UL) | (0x00100000UL) | (0x00200000UL) | (0x00400000UL) | (0x00800000UL) | (0x02000000UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 262)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 263)); } while (0);

    if (ENABLE == enNewState) {
        (((((CM_INTC_TypeDef *)(0x40051000UL))->WUPEN)) |= ((uint32_t)(u32WakeupSrc)));
    } else {
        (((((CM_INTC_TypeDef *)(0x40051000UL))->WUPEN)) &= ((uint32_t)(~((uint32_t)(u32WakeupSrc)))));
    }
}
...
void INTC_EventCmd(uint32_t u32Event, en_functional_state_t enNewState)
{
    ...
    do { ((( ((u32Event) != 0x00UL) && (((u32Event) | (0xFFFFFFFFUL)) == (0xFFFFFFFFUL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 281)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 282)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->EVTER) |= ((uint32_t)(u32Event)));
    } else {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->EVTER) &= ((uint32_t)(~((uint32_t)(u32Event)))));
    }
}
...
void INTC_IntCmd(uint32_t u32Int, en_functional_state_t enNewState)
{
    ...
    do { ((( ((u32Int) != 0x00UL) && (((u32Int) | (0xFFFFFFFFUL)) == (0xFFFFFFFFUL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 300)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 301)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->IER) |= ((uint32_t)(u32Int)));
    } else {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->IER) &= ((uint32_t)(~((uint32_t)(u32Int)))));
    }
}
...
void INTC_SWIntInit(uint32_t u32Ch, const func_ptr_t pfnCallback, uint32_t u32Priority)
{
    ...
    __NVIC_ClearPendingIRQ(stcIrqSignConfig.enIRQn);
    __NVIC_SetPriority(stcIrqSignConfig.enIRQn, u32Priority);
    __NVIC_EnableIRQ(stcIrqSignConfig.enIRQn);
}
...
void INTC_SWIntCmd(uint32_t u32SWInt, en_functional_state_t enNewState)
{
    ...
    do { ((( ((u32SWInt) != 0x00UL) && (((u32SWInt) | (0xFFFFFFFFUL)) == (0xFFFFFFFFUL)))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 341)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 342)); } while (0);

    if (ENABLE == enNewState) {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->SWIER) |= ((uint32_t)(u32SWInt)));
    } else {
        ((((CM_INTC_TypeDef *)(0x40051000UL))->SWIER) &= ((uint32_t)(~((uint32_t)(u32SWInt)))));
    }
}
...
int32_t NMI_StructInit(stc_nmi_init_t *pstcNmiInit)
{
    ...
    if (0 == pstcNmiInit) {
        ...
        pstcNmiInit->u32Edge = (0UL);
        pstcNmiInit->u32Filter = (0UL);
        pstcNmiInit->u32FilterClock = (0UL << (4U));
    }
    return i32Ret;
}
...
int32_t NMI_Init(const stc_nmi_init_t *pstcNmiInit)
{
    ...
    if (0 == pstcNmiInit) {
        ...
        do { ((( ((pstcNmiInit->u32Src) != 0x00UL) && (((pstcNmiInit->u32Src) | (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))) == (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 394)); } while (0);
         
        (((((CM_INTC_TypeDef *)(0x40051000UL))->NMICFR)) = ((uint32_t)((((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL))))));

         
        (((((CM_INTC_TypeDef *)(0x40051000UL))->NMIENR)) = ((uint32_t)(pstcNmiInit->u32Src)));

        do { ((( ((pstcNmiInit->u32Edge) == (0UL)) || ((pstcNmiInit->u32Edge) == ((0x00000001UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 401)); } while (0);
        do { ((( ((pstcNmiInit->u32Filter) == (0UL)) || ((pstcNmiInit->u32Filter) == ((0x00000080UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 402)); } while (0);
        do { ((( ((pstcNmiInit->u32FilterClock) == (0UL << (4U))) || ((pstcNmiInit->u32FilterClock) == (1UL << (4U))) || ((pstcNmiInit->u32FilterClock) == (2UL << (4U))) || ((pstcNmiInit->u32FilterClock) == (3UL << (4U))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 403)); } while (0);
        u32NMICR |= pstcNmiInit->u32Edge | pstcNmiInit->u32Filter | pstcNmiInit->u32FilterClock;
        ((((CM_INTC_TypeDef *)(0x40051000UL))->NMICR) &= ((uint32_t)(~((uint32_t)((0x00000080UL))))));

        ((((CM_INTC_TypeDef *)(0x40051000UL))->NMICR) = ((uint32_t)(u32NMICR)));
    }
    return i32Ret;
}
...
en_flag_status_t NMI_GetNmiStatus(uint32_t u32Src)
{
    ...
    do { ((( ((u32Src) != 0x00UL) && (((u32Src) | (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))) == (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 420)); } while (0);

    return ((((((CM_INTC_TypeDef *)(0x40051000UL))->NMIFR) & u32Src)) != 0UL) ? SET : RESET;
}
...
void NMI_NmiSrcCmd(uint32_t u32Src, en_functional_state_t enNewState)
{
    ...
    do { ((( ((u32Src) != 0x00UL) && (((u32Src) | (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))) == (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 434)); } while (0);
    do { (((((enNewState) == DISABLE) || ((enNewState) == ENABLE))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 435)); } while (0);

    if (ENABLE == enNewState) {
        (((((CM_INTC_TypeDef *)(0x40051000UL))->NMIENR)) |= ((uint32_t)(u32Src)));
    } else {
        (((((CM_INTC_TypeDef *)(0x40051000UL))->NMIENR)) &= ((uint32_t)(~((uint32_t)(u32Src)))));
    }
}
...
void NMI_ClearNmiStatus(uint32_t u32Src)
{
    ...
    do { ((( ((u32Src) != 0x00UL) && (((u32Src) | (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))) == (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000400UL)) | ((0x00000100UL)) | ((0x00000800UL)) | ((0x00000200UL)))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 452)); } while (0);

    (((((CM_INTC_TypeDef *)(0x40051000UL))->NMICFR)) = ((uint32_t)(u32Src)));
}
...
int32_t EXTINT_Init(uint32_t u32Ch, const stc_extint_init_t *pstcExtIntInit)
{
    ...
    if (0 == pstcExtIntInit) {
        ...
        do { ((( ((u32Ch) != 0x00UL) && (((u32Ch) | ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))) == ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 478)); } while (0);
        do { ((( ((pstcExtIntInit->u32Filter) == (0UL)) || ((pstcExtIntInit->u32Filter) == ((0x00000080UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 479)); } while (0);
        do { ((( ((pstcExtIntInit->u32FilterClock) == (0UL)) || ((pstcExtIntInit->u32FilterClock) == ((0x00000010UL))) || ((pstcExtIntInit->u32FilterClock) == ((0x00000020UL))) || ((pstcExtIntInit->u32FilterClock) == ((0x00000030UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 480)); } while (0);
        do { ((( ((pstcExtIntInit->u32Edge) == ((0x00000003UL))) || ((pstcExtIntInit->u32Edge) == ((0x00000001UL))) || ((pstcExtIntInit->u32Edge) == (0UL)) || ((pstcExtIntInit->u32Edge) == ((0x00000002UL))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 481)); } while (0);
        for (u8ExtIntPos = 0U; u8ExtIntPos < (16U); u8ExtIntPos++) {
            if (0UL != (u32Ch & (1UL << u8ExtIntPos))) {
                EIRQCRx = (volatile uint32_t *)((uint32_t)&((CM_INTC_TypeDef *)(0x40051000UL))->EIRQCR0 + 4UL * u8ExtIntPos);
...
int32_t EXTINT_StructInit(stc_extint_init_t *pstcExtIntInit)
{
    ...
    if (0 == pstcExtIntInit) {
        ...
        pstcExtIntInit->u32Filter      = (0UL);
        pstcExtIntInit->u32FilterClock = (0UL);
        pstcExtIntInit->u32Edge        = (0UL);
    }
    return i32Ret;
}
...
void EXTINT_ClearExtIntStatus(uint32_t u32ExtIntCh)
{
    ...
    do { ((( ((u32ExtIntCh) != 0x00UL) && (((u32ExtIntCh) | ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))) == ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 527)); } while (0);

    (((((CM_INTC_TypeDef *)(0x40051000UL))->EIFCR)) = ((uint32_t)(u32ExtIntCh)));
}
...
en_flag_status_t EXTINT_GetExtIntStatus(uint32_t u32ExtIntCh)
{
    ...
    do { ((( ((u32ExtIntCh) != 0x00UL) && (((u32ExtIntCh) | ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))) == ((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 6U) | (1UL << 7U) | (1UL << 8U) | (1UL << 9U) | (1UL <<10U) | (1UL <<11U) | (1UL <<12U) | (1UL <<13U) | (1UL <<14U) | (1UL <<15U))))) ? (void)0 : DDL_AssertHandler("..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_interrupts.c", 540)); } while (0);

    return ((((((CM_INTC_TypeDef *)(0x40051000UL))->EIFR)) & u32ExtIntCh) != 0U) ? SET : RESET;
}
...
void IRQ008_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT008_IRQn - (0U)]();
...
void IRQ009_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT009_IRQn - (0U)]();
...
void IRQ010_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT010_IRQn - (0U)]();
...
void IRQ011_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT011_IRQn - (0U)]();
...
void IRQ012_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT012_IRQn - (0U)]();
...
void IRQ013_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT013_IRQn - (0U)]();
...
void IRQ014_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT014_IRQn - (0U)]();
...
void IRQ015_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT015_IRQn - (0U)]();
...
void IRQ016_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT016_IRQn - (0U)]();
...
void IRQ017_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT017_IRQn - (0U)]();
...
void IRQ018_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT018_IRQn - (0U)]();
...
void IRQ019_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT019_IRQn - (0U)]();
...
void IRQ020_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT020_IRQn - (0U)]();
...
void IRQ021_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT021_IRQn - (0U)]();
...
void IRQ022_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT022_IRQn - (0U)]();
...
void IRQ023_Handler(void)
{
    m_apfnIrqHandler[(uint32_t)INT023_IRQn - (0U)]();
