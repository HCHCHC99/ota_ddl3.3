#line 1 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_utility.c"
...
#line 29 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_utility.c"
...
static volatile uint32_t m_u32TickCount = 0UL;
...
#line 129 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_utility.c"
...
{
    volatile uint32_t i;
    const uint32_t u32Cyc = ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) + 6000UL - 1UL) / 6000UL;
...
{
    volatile uint32_t i;
    const uint32_t u32Cyc = ((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) + 6000000UL - 1UL) / 6000000UL;
...
__attribute__((weak)) int32_t SysTick_Init(uint32_t u32Freq)
{
    int32_t i32Ret = (-1);
    ...
    if ((0UL != u32Freq) && (u32Freq <= 1000UL)) {
        ...
        if (0UL == SysTick_Config((SystemCoreClock >> ((((CM_CMU_TypeDef *)(0x40054000UL))->SCFGR & (0x07000000UL)) >> (24U))) / u32Freq)) {
            i32Ret = (0);
        }
    }
...
__attribute__((weak)) void SysTick_Delay(uint32_t u32Delay)
{
...
__attribute__((weak)) void SysTick_IncTick(void)
{
...
__attribute__((weak)) uint32_t SysTick_GetTick(void)
{
...
__attribute__((weak)) void SysTick_Suspend(void)
{
...
__attribute__((weak)) void SysTick_Resume(void)
{
...
__attribute__((weak)) void DDL_AssertHandler(const char *file, int line)
{
...
#line 424 "..\\..\\..\\..\\drivers\\hc32_ll_driver\\src\\hc32_ll_utility.c"
