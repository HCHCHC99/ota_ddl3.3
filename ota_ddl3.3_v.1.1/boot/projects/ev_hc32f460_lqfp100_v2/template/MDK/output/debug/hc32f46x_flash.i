...
#line 3 "..\\..\\Adp\\hc32f46x_flash.c"
#line 4 "..\\..\\Adp\\hc32f46x_flash.c"
...
static HC32FLASH_STATUS MapEFMStatusToHC32(int32_t efmStatus)
{
    switch(efmStatus)
    {
        ...
        default:
        {
            ...
            if (SET == EFM_GetStatus(((0x00000002UL))))
                return HC32FLASH_WPRERR;
            if (SET == EFM_GetStatus(((0x00000004UL))))
                return HC32FLASH_PGAERR;
            if (SET == EFM_GetStatus(((0x00000001UL))))
                return HC32FLASH_PEWERR;
            if (SET == EFM_GetStatus(((0x00000020UL))))
                return HC32FLASH_COLERR;
            if (SET == EFM_GetStatus(((0x00000008UL))))
...
HC32FLASH_STATUS HC32FLASH_GetStatus(void)
{
    ...
    fsr_value = ((CM_EFM_TypeDef *)(0x40010400UL))->FSR;
    
    if (RESET == EFM_GetStatus(((0x00000100UL))))
    {
        status = HC32FLASH_BUSY;
        ;
    }
    else if (SET == EFM_GetStatus(((0x00000002UL))))
    {
        status = HC32FLASH_WPRERR;
        ;
    }
    else if (SET == EFM_GetStatus(((0x00000004UL))))
    {
        status = HC32FLASH_PGAERR;
        ;
    }
    else if (SET == EFM_GetStatus(((0x00000001UL))))
    {
        status = HC32FLASH_PEWERR;
        ;
    }
    else if (SET == EFM_GetStatus(((0x00000020UL))))
    {
        status = HC32FLASH_COLERR;
        ;
    }
    else if (SET == EFM_GetStatus(((0x00000008UL))))
    {
...
void flash_test_example(void)
{
    ...
    status = HC32FLASH_EraseSector(0x00020000);
    if (status != HC32FLASH_OK)
    {
        flash_test_result = 1;
        ;
    ...
    status = HC32FLASH_WritedWord_NoCheck(0x00020000, 0x33333333);
    if (status != HC32FLASH_OK)
    {
        flash_test_result = 2;
        ;
    ...
    status = HC32FLASH_WritedWord_Check(0x00020000 + 16, 0x12345678);
    if (status != HC32FLASH_OK) 
    {
        flash_test_result = 2;
        ;
    ...
    status = HC32FLASH_WritedWord_NoCheck(0x00020000, 0x11111111);
    if (status != HC32FLASH_OK)
    {
        flash_test_result = 2;
        ;
    ...
    read_data = HC32FLASH_ReaddWord(0x00020000);
