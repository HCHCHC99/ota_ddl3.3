...
#line 2 "..\\..\\Utils\\Params.c"
#line 3 "..\\..\\Utils\\Params.c"
#line 4 "..\\..\\Utils\\Params.c"
...
#line 5 "..\\..\\Utils\\Params.c"
#line 6 "..\\..\\Utils\\Params.c"



 
AppParamRecord_t g_AppParam;             
...
{
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "========== Parameter Dump ==========" "\033[0m" "\r\n", "MAIN");
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "[Config Parameters - Flash Stored]" "\033[0m" "\r\n", "MAIN");
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_NODE_ID           (0x2710): %u" "\033[0m" "\r\n", "MAIN",g_AppParam . node_id);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_TARGET_SPEED      (0x2711): %d" "\033[0m" "\r\n", "MAIN",g_AppParam . target_speed);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_TARGET_ANGLE      (0x2712): %d (%.1f deg)" "\033[0m" "\r\n", "MAIN",g_AppParam . target_angle, (float)g_AppParam . target_angle / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_VOLTAGE_UPPER_LIMIT(0x2714): %u (%.1f V)" "\033[0m" "\r\n", "MAIN",g_AppParam . voltage_upper_limit, (float)g_AppParam . voltage_upper_limit / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_VOLTAGE_LOWER_LIMIT(0x2715): %u (%.1f V)" "\033[0m" "\r\n", "MAIN",g_AppParam . voltage_lower_limit, (float)g_AppParam . voltage_lower_limit / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_CURRENT_UPPER_LIMIT(0x2716): %u (%.1f A)" "\033[0m" "\r\n", "MAIN",g_AppParam . current_upper_limit, (float)g_AppParam . current_upper_limit / 1000.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_CLOSE_LIMIT_ANGLE (0x271C): %d (%.1f deg)" "\033[0m" "\r\n", "MAIN",g_AppParam . close_limit_angle, (float)g_AppParam . close_limit_angle / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_OPEN_LIMIT_ANGLE  (0x271D): %d (%.1f deg)" "\033[0m" "\r\n", "MAIN",g_AppParam . open_limit_angle, (float)g_AppParam . open_limit_angle / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  REG_CURRENT_DETECT_MS (0x271E): %u ms" "\033[0m" "\r\n", "MAIN",g_AppParam . current_detect_ms);
    
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "[Internal Parameters - Not Exposed to Modbus]" "\033[0m" "\r\n", "MAIN");
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  baud_rate:                 %lu" "\033[0m" "\r\n", "MAIN",g_AppParam . baud_rate);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  voltage_upper_hysteresis:  %u (%.1f V)" "\033[0m" "\r\n", "MAIN",g_AppParam . voltage_upper_hysteresis, (float)g_AppParam . voltage_upper_hysteresis / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  voltage_lower_hysteresis:  %u (%.1f V)" "\033[0m" "\r\n", "MAIN",g_AppParam . voltage_lower_hysteresis, (float)g_AppParam . voltage_lower_hysteresis / 10.0f);

    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  overvoltage_trigger_count: %u" "\033[0m" "\r\n", "MAIN",g_AppParam . overvoltage_trigger_count);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  undervoltage_trigger_count:%u" "\033[0m" "\r\n", "MAIN",g_AppParam . undervoltage_trigger_count);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  current_hysteresis_ma:     %u mA" "\033[0m" "\r\n", "MAIN",g_AppParam . current_hysteresis_ma);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  current_release_ms:        %u ms" "\033[0m" "\r\n", "MAIN",g_AppParam . current_release_ms);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  overcurrent_trigger_count: %u" "\033[0m" "\r\n", "MAIN",g_AppParam . overcurrent_trigger_count);
    
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "[Header/Footer Info]" "\033[0m" "\r\n", "MAIN");
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  head_magic:  0x%08X" "\033[0m" "\r\n", "MAIN",g_AppParam . head_magic);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  tail_magic:  0x%08X" "\033[0m" "\r\n", "MAIN",g_AppParam . tail_magic);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  sequence_id: %u" "\033[0m" "\r\n", "MAIN",g_AppParam . sequence_id);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  erase_count: %u" "\033[0m" "\r\n", "MAIN",g_AppParam . erase_count);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "  checksum:    0x%08X" "\033[0m" "\r\n", "MAIN",g_AppParam . checksum);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[PARAM_PRINT] " "===================================" "\033[0m" "\r\n", "MAIN");
}
