#line 1 "..\\..\\App\\Protocol_ModbusRtu.c"
...
#line 2 "..\\..\\App\\Protocol_ModbusRtu.c"
...
#line 3 "..\\..\\App\\Protocol_ModbusRtu.c"
...
#line 4 "..\\..\\App\\Protocol_ModbusRtu.c"
...
static void ModbusRTU_SendResponse(const uint8_t *pBuf, uint16_t len)
{
    ...
    if (!bRet)
    {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[MODBUS_ERR] Comm_HAL_Send FAILED! len=%d" "\033[0m" "\r\n", "MAIN",(int)(len + 2U));
    }
}
...
static void ModbusRTU_HandleReadHolding(uint8_t addr, uint16_t startReg, uint16_t regCount)
{
    ...
    {
        ((void)0);
        ModbusRTU_SendException(addr, (0x03U), (0x03U));
        return;
    }
    ...
    for (i = 0U; i < regCount; i++)
    {
        ...
        {
            ((void)0);
            ModbusRTU_SendException(addr, (0x03U), (0x02U));
            return;
        }
    }
    ...
    for (i = 0U; i < regCount; i++)
    {
        ...
        {
            ((void)0);
            ModbusRTU_SendException(addr, (0x03U), (0x04U));
            return;
        }
    }
...
static void ModbusRTU_HandleWriteSingle(uint8_t addr, uint16_t regAddr, uint16_t regValue)
{
    ...
    {
        ((void)0);
        ModbusRTU_SendException(addr, (0x06U), (0x02U));
        return;
    }
    ...
    {
        ((void)0);
        ModbusRTU_SendException(addr, (0x06U), (0x04U));
        return;
    }

     
    m_stcTxFrame.write_single.addr      = addr;
    m_stcTxFrame.write_single.func      = (0x06U);
    m_stcTxFrame.write_single.reg_addr  = (uint16_t)((((regAddr) >> 8U) & 0xFFU) | (((regAddr) & 0xFFU) << 8U));
    m_stcTxFrame.write_single.reg_value = (uint16_t)((((regValue) >> 8U) & 0xFFU) | (((regValue) & 0xFFU) << 8U));
...
static void ModbusRTU_HandleWriteMulti(uint8_t addr, uint16_t startReg, uint16_t regCount, const uint8_t *pData)
{
    ...
    {
        ((void)0);
        ModbusRTU_SendException(addr, (0x10U), (0x03U));
        return;
    }
    ...
    for (i = 0U; i < regCount; i++)
    {
        ...
        {
            ((void)0);
            ModbusRTU_SendException(addr, (0x10U), (0x02U));
            return;
        }
    }
    ...
    if (m_stcCallbacks.on_write_multi)
    {
        ...
        {
            ((void)0);
            ModbusRTU_SendException(addr, (0x10U), (0x04U));
            return;
        }
    }
    else
    ...
    m_stcTxFrame.write_multi.func       = (0x10U);
    m_stcTxFrame.write_multi.start_reg  = (uint16_t)((((startReg) >> 8U) & 0xFFU) | (((startReg) & 0xFFU) << 8U));
    m_stcTxFrame.write_multi.reg_count  = (uint16_t)((((regCount) >> 8U) & 0xFFU) | (((regCount) & 0xFFU) << 8U));
...
void ModbusRTU_ProcessFrame(const uint8_t *frame, uint16_t len)
{
    ...
    case (0x03U):
    {
        if (dataLen < 4U)
        {
            ModbusRTU_SendException(addr, func, (0x03U));
            break;
        }
        uint16_t startReg = (uint16_t)((((m_stcTxFrame . read_holding . start_reg) >> 8U) & 0xFFU) | (((m_stcTxFrame . read_holding . start_reg) & 0xFFU) << 8U));
        uint16_t regCount = (uint16_t)((((m_stcTxFrame . read_holding . reg_count) >> 8U) & 0xFFU) | (((m_stcTxFrame . read_holding . reg_count) & 0xFFU) << 8U));
    ...
    case (0x06U):
    {
        ...
        uint16_t regAddr  = (uint16_t)((((m_stcTxFrame . write_single . reg_addr) >> 8U) & 0xFFU) | (((m_stcTxFrame . write_single . reg_addr) & 0xFFU) << 8U));
        uint16_t regValue = (uint16_t)((((m_stcTxFrame . write_single . reg_value) >> 8U) & 0xFFU) | (((m_stcTxFrame . write_single . reg_value) & 0xFFU) << 8U));
    ...
    case (0x10U):
    {
        ...
        {
            ModbusRTU_SendException(addr, func, (0x01U));
            break;
        }
        if (dataLen < 5U)
        {
        ...
        uint16_t startReg  = (uint16_t)((((m_stcTxFrame . write_multi . start_reg) >> 8U) & 0xFFU) | (((m_stcTxFrame . write_multi . start_reg) & 0xFFU) << 8U));
        uint16_t regCount  = (uint16_t)((((m_stcTxFrame . write_multi . reg_count) >> 8U) & 0xFFU) | (((m_stcTxFrame . write_multi . reg_count) & 0xFFU) << 8U));
