...
{
    if (baudrate <= 4800UL)       return (3UL);
    else if (baudrate <= 38400UL) return (2UL);
    else if (baudrate <= 115200UL) return (1UL);
    else                           return (0UL);
}
...
static void INTC_IrqInstalHandler(const stc_irq_signin_config_t *cfg, uint32_t prio)
{
    ...
    {
        INTC_IrqSignIn(cfg);
        __NVIC_ClearPendingIRQ(cfg->enIRQn);
        __NVIC_SetPriority(cfg->enIRQn, prio);
        __NVIC_EnableIRQ(cfg->enIRQn);
    }
}
...
{
    LL_PERIPH_WE((1UL << 2U));
    Output_GPIO_Init(((0x00U)), ((0x0008U)), GPIO_INIT_LOW);
    GPIO_SetFunc(((0x00U)), ((0x0008U)), (0U));
    LL_PERIPH_WP((1UL << 2U));
    ((void)0);
}
...
static void RS485_SetTxMode(void)
{
    ...
    {
        GPIO_SetPins(((0x00U)), ((0x0008U)));
    }
    else
    {
        GPIO_ResetPins(((0x00U)), ((0x0008U)));
    }
}
...
{
    uint8_t ch = (uint8_t)USART_ReadData((((CM_USART_TypeDef *)(0x40021400UL))));
    if (m_pfnRxCallback) {
        m_pfnRxCallback(ch);
    }
}
...
{
    uint32_t errFlag = ((0x00000008UL)) | ((0x00000002UL)) | ((0x00000001UL));
    USART_ClearStatus((((CM_USART_TypeDef *)(0x40021400UL))), errFlag);
    (void)USART_ReadData((((CM_USART_TypeDef *)(0x40021400UL))));
...
{
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000080UL)), DISABLE);
...
{
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000008UL)) | ((0x00000080UL)) | ((0x00000040UL)), DISABLE);
...
void RS485_HW_Init(const RS485_HW_Config_t *cfg)
{
    ...
    m_pfnRxCallback         = 0;
    m_pfnTxReadyCallback    = 0;
    m_pfnTxCompleteCallback = 0;
    m_pfnErrorCallback      = 0;

     
    GPIO_SetFunc(((0x01U)), ((0x1000U)), ((37U)));
    GPIO_SetFunc(((0x01U)), ((0x2000U)), ((36U)));

     
    FCG_Fcg1PeriphClockCmd(((0x08000000UL)), ENABLE);
    USART_UART_StructInit(&uartCfg);
    uartCfg.u32Baudrate      = cfg->baudrate;
    uartCfg.u32ClockDiv      = RS485_GetClkDiv(cfg->baudrate);
    uartCfg.u32OverSampleBit = (0UL);
    USART_UART_Init((((CM_USART_TypeDef *)(0x40021400UL))), &uartCfg, 0);

     
    irqCfg.enIRQn = (INT000_IRQn);
    irqCfg.enIntSrc = (INT_SRC_USART4_EI);
    irqCfg.pfnCallback = USART_RxError_IrqCallback;
    INTC_IrqInstalHandler(&irqCfg, ((15U)));

    irqCfg.enIRQn = (INT001_IRQn);
    irqCfg.enIntSrc = (INT_SRC_USART4_RI);
    irqCfg.pfnCallback = USART_RxFull_IrqCallback;
    INTC_IrqInstalHandler(&irqCfg, ((15U)));

    irqCfg.enIRQn = (INT002_IRQn);
    irqCfg.enIntSrc = (INT_SRC_USART4_TI);
    irqCfg.pfnCallback = USART_TxEmpty_IrqCallback;
    INTC_IrqInstalHandler(&irqCfg, ((15U)));

    irqCfg.enIRQn = (INT003_IRQn);
    irqCfg.enIntSrc = (INT_SRC_USART4_TCI);
    ...
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000004UL)) | ((0x00000020UL)), ENABLE);
...
void RS485_HW_DeInit(void)
{
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000020UL)) | ((0x00000080UL)) | ((0x00000040UL)), DISABLE);
    __NVIC_DisableIRQ((INT000_IRQn));
    __NVIC_DisableIRQ((INT001_IRQn));
    __NVIC_DisableIRQ((INT002_IRQn));
    __NVIC_DisableIRQ((INT003_IRQn));
...
void RS485_HW_SendByte(uint8_t byte)
{
    USART_WriteData((((CM_USART_TypeDef *)(0x40021400UL))), byte);
}

void RS485_HW_StartTx(void)
{
    RS485_SetTxMode();
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000004UL)) | ((0x00000020UL)), DISABLE);
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000008UL)), ENABLE);
    ((void)0);
}
...
void RS485_HW_EnableTxEmptyInt(void)
{
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000080UL)), ENABLE);
}

void RS485_HW_EnableTxCompleteInt(void)
{
    USART_FuncCmd((((CM_USART_TypeDef *)(0x40021400UL))), ((0x00000040UL)), ENABLE);
}
