...
#line 10 "..\\..\\Adp\\Sysclk.c"
#line 11 "..\\..\\Adp\\Sysclk.c"
#line 12 "..\\..\\Adp\\Sysclk.c"



 

static void SysTick_NVIC_Config(void);
static int32_t SysTick_Clock_Enable(void);


static int32_t SysTick_PLL_Init(void);



static int32_t SysTick_XTAL_Init(void);



static int32_t SysTick_XTAL32_Init(void);
...
static int32_t SysTick_LRC_Init(void);
...
int32_t Systick_config(void)
{
    ...
    LL_PERIPH_WE(((1UL << 0U) | (1UL << 1U) | (1UL << 2U) | (1UL << 3U) | (1UL << 4U) | (1UL << 5U) | (1UL << 7U) | (1UL << 6U)));
    
     
    i32Ret = SysTick_Clock_Enable();
    if (i32Ret != (0)) {
        return -1;
    }
    ...
    while (SET != CLK_GetStableStatus(((0x20U)))) {
        ;
    }

    
     
    SRAM_SetWaitCycle((1UL << 2U), (0U), (0U));
    SRAM_SetWaitCycle(((1UL << 0U) | (1UL << 1U) | (1UL << 3U)), (1U), (1U));
    
     
    (void)EFM_SetWaitCycle((5U << (4U)));
    
     
    GPIO_SetReadWaitCycle((0x03U << (14U)));
    
     
    (void)PWC_HighSpeedToHighPerformance();
    
     
    CLK_SetSysClockSrc((0x05U));
    ...
    u32Reload = (SystemCoreClock / 1000UL) * (1UL) - 1UL;
    
     
    if (u32Reload > (0xFFFFFFUL )) {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_DEBUG] " "Error: Reload value %lu exceeds 24-bit max (0x%lX)" "\033[0m" "\r\n", "MAIN",u32Reload, (0xFFFFFFUL ));

        return -1;
    }
    
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_DEBUG] " "SysTick reload value: %lu (expected 199999 for 200MHz)" "\033[0m" "\r\n", "MAIN",u32Reload);
    
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = u32Reload;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0UL;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = ((1UL) << 2U) |
                    (1UL << 1U) |
                    (1UL );
...
static int32_t SysTick_Clock_Enable(void)
{
    ...
    i32Ret = SysTick_LRC_Init();
    if (i32Ret != (0)) return i32Ret;

    
     

    i32Ret = SysTick_XTAL_Init();
    if (i32Ret != (0)) return i32Ret;

    
     

    i32Ret = SysTick_XTAL32_Init();
    if (i32Ret != (0)) return i32Ret;

    
     

    i32Ret = SysTick_PLL_Init();
    if (i32Ret != (0)) return i32Ret;
...
static int32_t SysTick_PLL_Init(void)
{
    ...
    stcPLLInit.PLLCFGR_f.PLLSRC = (0x00UL);
    stcPLLInit.PLLCFGR_f.PLLM = (1UL) - 1UL;
    stcPLLInit.PLLCFGR_f.PLLN = (50UL) - 1UL;
    stcPLLInit.PLLCFGR_f.PLLP = (2UL) - 1UL;
    stcPLLInit.PLLCFGR_f.PLLQ = (2UL) - 1UL;
    stcPLLInit.PLLCFGR_f.PLLR = (2UL) - 1UL;
    stcPLLInit.u8PLLState = (0x00U);
    
    i32Ret = CLK_PLLInit(&stcPLLInit);
    return i32Ret;
}
...
static int32_t SysTick_XTAL_Init(void)
{
    ...
    stcXtalInit.u8State = (0x00U);
    stcXtalInit.u8Mode = (0x00U);
    stcXtalInit.u8Drv = (0x03U << (4U));
    stcXtalInit.u8StableTime = (0x05U);
...
static int32_t SysTick_XTAL32_Init(void)
{
    ...
    stcXtal32Init.u8State = (0x00U);
    stcXtal32Init.u8Drv = (0x00U);
    stcXtal32Init.u8Filter = (0x00U);
...
static void SysTick_NVIC_Config(void)
{
    __NVIC_SetPriority(SysTick_IRQn, 15U);
}
...
void Print_All_Clock_Freq(void)
{
    ...
    i32Ret = CLK_GetClockFreq(&stcClkFreq);
    
     
    if (i32Ret != (0)) {
        SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_DEBUG] " "CLK_GetClockFreq failed! Error code: %d" "\033[0m" "\r\n", "MAIN",i32Ret);
        return;
    }
    
     
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "========== System Clock Frequencies ==========" "\033[0m" "\r\n", "MAIN");
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "System Clock (SYSCLK) : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32SysclkFreq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "HCLK (AHB Clock)      : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32HclkFreq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "PCLK0 (APB0 Clock)    : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32Pclk0Freq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "PCLK1 (APB1 Clock)    : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32Pclk1Freq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "PCLK2 (APB2 Clock)    : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32Pclk2Freq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "PCLK3 (APB3 Clock)    : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32Pclk3Freq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "PCLK4 (APB4 Clock)    : %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32Pclk4Freq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "External Clock (EXCLK): %u Hz" "\033[0m" "\r\n", "MAIN",stcClkFreq . u32ExclkFreq);
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_OUT] " "==============================================" "\033[0m" "\r\n", "MAIN");
    
     
    SEGGER_RTT_printf(LOG_CH_MAIN, "\033[36m" "[%s] " "[CLOCK_DEBUG] " "Clock frequency acquisition completed successfully" "\033[0m" "\r\n", "MAIN");
}
