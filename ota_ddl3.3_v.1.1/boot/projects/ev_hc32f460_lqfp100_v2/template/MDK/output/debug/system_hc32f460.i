#line 1 "../../../../drivers/cmsis/Device/HDSC/hc32f4xx/Source/system_hc32f460.c"
...
#line 137 "../../../../drivers/cmsis/Device/HDSC/hc32f4xx/Include/system_hc32f460.h"
...
#line 28 "../../../../drivers/cmsis/Device/HDSC/hc32f4xx/Source/system_hc32f460.c"
...
__attribute__((section(".bss.noinit"), zero_init)) uint32_t SystemCoreClock;
 
__attribute__((section(".bss.noinit"), zero_init)) uint32_t HRC_VALUE;
...
void SystemInit(void)
{
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (0x0UL);     
}
...
void SystemCoreClockUpdate(void)
{
    ...
    if (1UL == ((*((volatile uint32_t *)(0x40010684UL))) & 1UL)) {
        HRC_VALUE = (16000000UL);
    } else {
        HRC_VALUE = (20000000UL);
    }
    u8SysClkSrc = ((CM_CMU_TypeDef *)(0x40054000UL))->CKSWR & (0x07U);
    switch (u8SysClkSrc) {
        case 0x00U:  
        ...
        case 0x05U:   
            ...
            plln = (((CM_CMU_TypeDef *)(0x40054000UL))->PLLCFGR & (0x0001FF00UL)) >> (8U);
            pllp = (((CM_CMU_TypeDef *)(0x40054000UL))->PLLCFGR & (0xF0000000UL)) >> (28U);
            pllm = (((CM_CMU_TypeDef *)(0x40054000UL))->PLLCFGR & (0x0000001FUL)) >> (0U);
            if (0UL == (((CM_CMU_TypeDef *)(0x40054000UL))->PLLCFGR & (0x00000080UL))) {   
                u32PllSrcFreq = (8000000UL);
            } else {                                     
...
#line 192 "../../../../drivers/cmsis/Device/HDSC/hc32f4xx/Source/system_hc32f460.c"
