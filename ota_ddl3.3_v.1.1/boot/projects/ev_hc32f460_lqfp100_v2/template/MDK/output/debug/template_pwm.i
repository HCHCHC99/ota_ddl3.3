...
void Template_Pwm_TmrAConfig(void)
{
    ...
    u32PeriodValue = u32TimerClk / (10000UL);
    ...
    FCG_Fcg2PeriphClockCmd((((0x00000020UL))), ENABLE);

     
    (void)TMRA_StructInit(&stcTmraInit);
    stcTmraInit.sw_count.u8CountMode = ((0x0U));
    stcTmraInit.sw_count.u8CountDir  = (((0x02U)));
    stcTmraInit.u32PeriodValue = u32PeriodValue;
    (void)TMRA_Init((((CM_TMRA_TypeDef *)(0x40015C00UL))), &stcTmraInit);

     
    (void)TMRA_PWM_StructInit(&stcPwmInit);
    
#line 99 "..\\..\\Adp\\Template_Pwm.c"
     
    stcPwmInit.u32CompareValue        = (u32PeriodValue * (30U)) / 100U;
    ...
    TMRA_Start((((CM_TMRA_TypeDef *)(0x40015C00UL))));  
}
