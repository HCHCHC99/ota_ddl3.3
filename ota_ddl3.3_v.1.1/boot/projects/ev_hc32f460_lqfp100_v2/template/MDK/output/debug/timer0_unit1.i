...
static uint32_t TMR0_GetChannelConfig(TMR0_Channel1_t ch, uint32_t *int_src, uint32_t *int_flag, uint32_t *int_type)
{
    if (ch == TMR0_CHANNEL_A_1) {
        ...
        *int_flag = ((0x00000001UL));
        *int_type = ((0x00000004UL));
        return (0UL);
    } else {
        *int_src = INT_SRC_TMR0_1_CMP_B;
        *int_flag = ((0x00010000UL));
        *int_type = ((0x00040000UL));
        return (1UL);
    }
}
...
int32_t TMR0_Unit1_Init(TMR0_Channel1_t ch, uint32_t period_us, ReCount1_t cmd)
{
    ...
    u32Compare = (uint16_t)(((uint64_t)(period_us) * (u32Pclk1)) / 1000000U);   
    u32Compare = u32Compare - 1UL;
    
    (void)TMR0_StructInit(&stcTmr0Init);
    stcTmr0Init.u32ClockSrc = (0UL);
    stcTmr0Init.u32ClockDiv = (0UL << (4U));   
    stcTmr0Init.u32Func = (0UL);
    stcTmr0Init.u16CompareValue = (uint16_t)u32Compare;
    
    if ((0) != TMR0_Init((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch, &stcTmr0Init)) {
        return -1;
    }
    
    TMR0_SetCountValue((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch, s_saved_count[ch_idx]);
    TMR0_ClearStatus((((CM_TMR0_TypeDef *)(0x40024000UL))), int_flag);
    TMR0_IntCmd((((CM_TMR0_TypeDef *)(0x40024000UL))), int_type, ENABLE);
    ...
    if (!s_irq_registered) {
        ...
        if ((0) != INTC_IrqSignIn(&stcIrqSignConfig)) {
            return -1;
        }
        
        __NVIC_ClearPendingIRQ((INT006_IRQn));
        __NVIC_SetPriority((INT006_IRQn), 1UL);
        __NVIC_EnableIRQ((INT006_IRQn));
        
        s_irq_registered = 1;
    }
    
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
...
int32_t TMR0_Unit1_DeInit(TMR0_Channel1_t ch)
{
    ...
    s_saved_count[ch_idx] = TMR0_GetCountValue((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
    
    TMR0_Stop((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
    TMR0_IntCmd((((CM_TMR0_TypeDef *)(0x40024000UL))), int_type, DISABLE);
    TMR0_ClearStatus((((CM_TMR0_TypeDef *)(0x40024000UL))), int_flag);
    
    (void)TMR0_DeInit((((CM_TMR0_TypeDef *)(0x40024000UL))));
    
    if (ch == TMR0_CHANNEL_B_1) {
        __NVIC_DisableIRQ((INT006_IRQn));
        __NVIC_ClearPendingIRQ((INT006_IRQn));
    }
...
int32_t TMR0_Unit1_Reconfig(TMR0_Channel1_t ch)
{
    ...
    u32Compare = (uint16_t)(((uint64_t)(s_target_period[ch_idx]) * (u32Pclk1)) / 1000000U);
    u32Compare = u32Compare - 1UL;
    
    TMR0_SetCompareValue((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch, (uint16_t)u32Compare);
    TMR0_SetCountValue((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch, s_saved_count[ch_idx]);
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
...
void TMR0_Unit1_Start(TMR0_Channel1_t ch)
{
    uint32_t timer_ch = (ch == TMR0_CHANNEL_A_1) ? (0UL) : (1UL);
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
}
...
{
    uint32_t timer_ch = (ch == TMR0_CHANNEL_A_1) ? (0UL) : (1UL);
    return TMR0_GetCountValue((((CM_TMR0_TypeDef *)(0x40024000UL))), timer_ch);
}

static void TMR0_Unit1_IRQHandler(void)
{
    if (TMR0_GetStatus((((CM_TMR0_TypeDef *)(0x40024000UL))), ((0x00000001UL))) == SET) {
        TMR0_ClearStatus((((CM_TMR0_TypeDef *)(0x40024000UL))), ((0x00000001UL)));
         
    }
    
    if (TMR0_GetStatus((((CM_TMR0_TypeDef *)(0x40024000UL))), ((0x00010000UL))) == SET) {
