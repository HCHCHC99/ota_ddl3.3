...
int32_t TMR0_Unit2_Init(TMR0_Channel2_t ch, uint32_t period_us, ReCount2_t cmd)
{
    ...
    FCG_Fcg2PeriphClockCmd((((0x00000002UL))), ENABLE);
    
    CLK_GetClockFreq(&stcClkFreq);
    u32Pclk1 = stcClkFreq.u32Pclk1Freq;
    
    u32Compare = (uint16_t)(((uint64_t)(period_us) * ((u32Pclk1 / 64UL))) / 1000000U);
    u32Compare = u32Compare - 1UL;
    
    (void)TMR0_StructInit(&stcTmr0Init);
    stcTmr0Init.u32ClockSrc = (0UL);
    stcTmr0Init.u32ClockDiv = (6UL << (4U));
    stcTmr0Init.u32Func = (0UL);
    stcTmr0Init.u16CompareValue = (uint16_t)u32Compare;
    
    if ((0) != TMR0_Init((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch, &stcTmr0Init)) {
        return -1;
    }
    
    TMR0_SetCountValue((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch, s_saved_count[ch_idx]);
    TMR0_ClearStatus((((CM_TMR0_TypeDef *)(0x40024400UL))), int_flag);
    TMR0_IntCmd((((CM_TMR0_TypeDef *)(0x40024400UL))), int_type, ENABLE);
    ...
    if (!s_irq_registered) {
        ...
        __NVIC_ClearPendingIRQ((INT007_IRQn));
        __NVIC_SetPriority((INT007_IRQn), 1UL);
        __NVIC_EnableIRQ((INT007_IRQn));
        
        s_irq_registered = 1;
    }
    
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
...
int32_t TMR0_Unit2_DeInit(TMR0_Channel2_t ch)
{
    ...
    s_saved_count[ch_idx] = TMR0_GetCountValue((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
    
    TMR0_Stop((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
    TMR0_IntCmd((((CM_TMR0_TypeDef *)(0x40024400UL))), int_type, DISABLE);
    TMR0_ClearStatus((((CM_TMR0_TypeDef *)(0x40024400UL))), int_flag);
    
    (void)TMR0_DeInit((((CM_TMR0_TypeDef *)(0x40024400UL))));
    
    if (ch == TMR0_CHANNEL_B_2) {
        __NVIC_DisableIRQ((INT007_IRQn));
        __NVIC_ClearPendingIRQ((INT007_IRQn));
    }
...
int32_t TMR0_Unit2_Reconfig(TMR0_Channel2_t ch)
{
    ...
    u32Compare = (uint16_t)(((uint64_t)(s_target_period[ch_idx]) * ((u32Pclk1 / 64UL))) / 1000000U);
    u32Compare = u32Compare - 1UL;
    
    TMR0_SetCompareValue((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch, (uint16_t)u32Compare);
    TMR0_SetCountValue((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch, s_saved_count[ch_idx]);
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
...
void TMR0_Unit2_Start(TMR0_Channel2_t ch)
{
    uint32_t timer_ch = (ch == TMR0_CHANNEL_A_2) ? (0UL) : (1UL);
    TMR0_Start((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
}
...
{
    uint32_t timer_ch = (ch == TMR0_CHANNEL_A_2) ? (0UL) : (1UL);
    return TMR0_GetCountValue((((CM_TMR0_TypeDef *)(0x40024400UL))), timer_ch);
}
