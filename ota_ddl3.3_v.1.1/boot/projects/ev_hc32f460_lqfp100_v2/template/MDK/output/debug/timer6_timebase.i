...
static uint32_t m_u32TimerFreq = 0;      
...
void Timer6_Timebase_Init(void) {
    stc_tmr6_init_t stcTmrInit;
    
     
    uint32_t u32Pclk0Freq = CLK_GetBusClockFreq(((0x00000007UL)));
    
     
    m_u32TimerFreq = u32Pclk0Freq / 64u;
    
     
    FCG_Fcg2PeriphClockCmd(((0x00020000UL)), ENABLE);
    
     
    TMR6_DeInit(((CM_TMR6_TypeDef *)(0x40018400UL)));
    
     
    TMR6_StructInit(&stcTmrInit);
    
     
    stcTmrInit.u8CountSrc = (0U);
    stcTmrInit.sw_count.u32CountDir = ((0x00000100UL));
    stcTmrInit.sw_count.u32ClockDiv = (0x05UL << (4U));
    stcTmrInit.sw_count.u32CountMode = (0x00UL);
    stcTmrInit.u32PeriodValue = 0xFFFFu;
    
    TMR6_Init(((CM_TMR6_TypeDef *)(0x40018400UL)), &stcTmrInit);
    
     
    TMR6_ClearStatus(((CM_TMR6_TypeDef *)(0x40018400UL)), (0x00001EFFUL));
    
     
    TMR6_IntCmd(((CM_TMR6_TypeDef *)(0x40018400UL)), (((0x00000001UL)) | ((0x00000002UL)) | ((0x00000004UL)) | ((0x00000008UL)) | ((0x00000010UL)) | ((0x00000020UL)) | ((0x00000040UL)) | ((0x00000080UL)) | ((0x00000100UL)) | ((0x00010000UL)) | ((0x00020000UL)) | ((0x00040000UL)) | ((0x00080000UL))), DISABLE);
...
void Timer6_Timebase_Start(void) { TMR6_Start(((CM_TMR6_TypeDef *)(0x40018400UL))); }
void Timer6_Timebase_Stop(void) { TMR6_Stop(((CM_TMR6_TypeDef *)(0x40018400UL))); }
uint32_t Timer6_Timebase_GetCounter(void) { return TMR6_GetCountValue(((CM_TMR6_TypeDef *)(0x40018400UL))); }
